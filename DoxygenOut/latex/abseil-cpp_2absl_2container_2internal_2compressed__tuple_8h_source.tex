...
\hypertarget{abseil-cpp_2absl_2container_2internal_2compressed__tuple_8h_source}{}\label{abseil-cpp_2absl_2container_2internal_2compressed__tuple_8h_source}\index{abseil-\/cpp/absl/container/internal/compressed\_tuple.h@{abseil-\/cpp/absl/container/internal/compressed\_tuple.h}}
\mbox{\hyperlink{abseil-cpp_2absl_2container_2internal_2compressed__tuple_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00098\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{abseil-cpp_2absl_2container_2internal_2compressed__tuple_8h_a603facfbb644d6bb5e568d5598c23242}{ABSL\_INTERNAL\_COMPRESSED\_TUPLE\_DECLSPEC}}\ Storage<T,\ I,\ true>\ :\ T\ \{}
...
\DoxyCodeLine{00162\ \textcolor{keyword}{struct\ }TupleMoveConstructible<true,\ \mbox{\hyperlink{classabsl_1_1container__internal_1_1CompressedTuple}{CompressedTuple}}<Ts...>,\ Vs...>}
...
\DoxyCodeLine{00168\ \textcolor{keyword}{struct\ }compressed\_tuple\_size;}
\DoxyCodeLine{00169\ }
\DoxyCodeLine{00170\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ Es>}
\DoxyCodeLine{00171\ \textcolor{keyword}{struct\ }compressed\_tuple\_size<CompressedTuple<Es...>>}
...
\DoxyCodeLine{00175\ \textcolor{keyword}{struct\ }TupleItemsMoveConstructible}
...
\DoxyCodeLine{00202\ \textcolor{keyword}{class\ }\mbox{\hyperlink{abseil-cpp_2absl_2container_2internal_2compressed__tuple_8h_a603facfbb644d6bb5e568d5598c23242}{ABSL\_INTERNAL\_COMPRESSED\_TUPLE\_DECLSPEC}}\ CompressedTuple}
...
\DoxyCodeLine{00208\ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{namespaceabsl_1_1container__internal_1_1internal__compressed__tuple_a8e77adc0a4e53f56fad02413b91cfbad}{ElemT}}\ =\ internal\_compressed\_tuple::ElemT<CompressedTuple,\ I>;}
\DoxyCodeLine{00209\ }
\DoxyCodeLine{00210\ \ \ \textcolor{keyword}{template}\ <\textcolor{keywordtype}{int}\ I>}
\DoxyCodeLine{00211\ \ \ \textcolor{keyword}{using\ }StorageT\ =\ internal\_compressed\_tuple::Storage<ElemT<I>,\ I>;}
\DoxyCodeLine{00212\ }
...
\DoxyCodeLine{00218\ \ \ \textcolor{keyword}{constexpr}\ CompressedTuple()\ :\ CompressedTuple::\mbox{\hyperlink{namespaceabsl_1_1container__internal_1_1internal__compressed__tuple_a2ef1ba90a45b36f04113d51c6ba0fa22}{CompressedTupleImpl}}()\ \{\}}
...
\DoxyCodeLine{00263\ \textcolor{keyword}{class\ }\mbox{\hyperlink{abseil-cpp_2absl_2container_2internal_2compressed__tuple_8h_a603facfbb644d6bb5e568d5598c23242}{ABSL\_INTERNAL\_COMPRESSED\_TUPLE\_DECLSPEC}}\ CompressedTuple<>\ \{\};}
\DoxyCodeLine{00264\ }
