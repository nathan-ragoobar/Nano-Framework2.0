...
\hypertarget{OriginalStuff_2eigen_2Eigen_2src_2Geometry_2OrthoMethods_8h_source}{}\label{OriginalStuff_2eigen_2Eigen_2src_2Geometry_2OrthoMethods_8h_source}\index{OriginalStuff/eigen/Eigen/src/Geometry/OrthoMethods.h@{OriginalStuff/eigen/Eigen/src/Geometry/OrthoMethods.h}}
\mbox{\hyperlink{OriginalStuff_2eigen_2Eigen_2src_2Geometry_2OrthoMethods_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00035\ \mbox{\hyperlink{classEigen_1_1MatrixBase_a37b2064df225f1530be0942bee1125b5}{MatrixBase<Derived>::cross}}(\textcolor{keyword}{const}\ MatrixBase<OtherDerived>\&\ other)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00042\ \ \ typename\ \mbox{\hyperlink{namespaceinternal}{internal}}::nested\_eval<Derived,2>::type\ lhs(derived());}
\DoxyCodeLine{00043\ \ \ typename\ \mbox{\hyperlink{namespaceinternal}{internal}}::nested\_eval<OtherDerived,2>::type\ rhs(other.derived());}
\DoxyCodeLine{00044\ \ \ return\ typename\ cross\_product\_return\_type<OtherDerived>::type(}
\DoxyCodeLine{00045\ \ \ \ \ numext::\mbox{\hyperlink{namespaceEigen_a065d353fcbff30a8e902d2900a784d45}{conj}}(lhs.coeff(1)\ *\ rhs.coeff(2)\ -\/\ lhs.coeff(2)\ *\ rhs.coeff(1)),}
\DoxyCodeLine{00046\ \ \ \ \ numext::\mbox{\hyperlink{namespaceEigen_a065d353fcbff30a8e902d2900a784d45}{conj}}(lhs.coeff(2)\ *\ rhs.coeff(0)\ -\/\ lhs.coeff(0)\ *\ rhs.coeff(2)),}
\DoxyCodeLine{00047\ \ \ \ \ numext::\mbox{\hyperlink{namespaceEigen_a065d353fcbff30a8e902d2900a784d45}{conj}}(lhs.coeff(0)\ *\ rhs.coeff(1)\ -\/\ lhs.coeff(1)\ *\ rhs.coeff(0))}
\DoxyCodeLine{00048\ \ \ );}
\DoxyCodeLine{00049\ \}}
\DoxyCodeLine{00050\ }
\DoxyCodeLine{00051\ namespace\ \mbox{\hyperlink{namespaceinternal}{internal}}\ \{}
\DoxyCodeLine{00052\ }
...
\DoxyCodeLine{00055\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{bool}\ Vectorizable\ =\ \mbox{\hyperlink{namespaceexport__hf_a3b79f4dc99a74534a694b2cd70b161bd}{bool}}((VectorLhs::Flags\&VectorRhs::Flags)\&\mbox{\hyperlink{group__flags_ga1a306a438e1ab074e8be59512e887b9f}{PacketAccessBit}})>}
...
\DoxyCodeLine{00083\ \mbox{\hyperlink{classEigen_1_1MatrixBase_ac01e7f46c4dfbacc362aaec8b00c115a}{MatrixBase<Derived>::cross3}}(\textcolor{keyword}{const}\ MatrixBase<OtherDerived>\&\ other)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00087\ }
\DoxyCodeLine{00088\ \ \ typedef\ typename\ \mbox{\hyperlink{namespaceinternal}{internal}}::nested\_eval<Derived,2>::type\ DerivedNested;}
\DoxyCodeLine{00089\ \ \ typedef\ typename\ \mbox{\hyperlink{namespaceinternal}{internal}}::nested\_eval<OtherDerived,2>::type\ OtherDerivedNested;}
\DoxyCodeLine{00090\ \ \ DerivedNested\ lhs(derived());}
\DoxyCodeLine{00091\ \ \ OtherDerivedNested\ rhs(other.derived());}
\DoxyCodeLine{00092\ }
\DoxyCodeLine{00093\ \ \ return\ \mbox{\hyperlink{namespaceinternal}{internal}}::cross3\_impl<Architecture::Target,}
\DoxyCodeLine{00094\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ typename\ \mbox{\hyperlink{namespaceinternal}{internal}}::remove\_all<DerivedNested>::type,}
\DoxyCodeLine{00095\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ typename\ \mbox{\hyperlink{namespaceinternal}{internal}}::remove\_all<OtherDerivedNested>::type>::run(lhs,rhs);}
\DoxyCodeLine{00096\ \}}
\DoxyCodeLine{00097\ }
\DoxyCodeLine{00107\ template<typename\ ExpressionType,\ \textcolor{keywordtype}{int}\ Direction>}
\DoxyCodeLine{00108\ template<typename\ OtherDerived>}
...
\DoxyCodeLine{00110\ const\ typename\ VectorwiseOp<ExpressionType,Direction>::CrossReturnType}
\DoxyCodeLine{00111\ VectorwiseOp<ExpressionType,Direction>::cross(const\ MatrixBase<OtherDerived>\&\ other)\textcolor{keyword}{\ const}}
...
\DoxyCodeLine{00114\ \ \ \mbox{\hyperlink{eigen_2Eigen_2src_2Core_2util_2StaticAssert_8h_ac95cf960f4a8395b28af90edfda755f0}{EIGEN\_STATIC\_ASSERT}}((\mbox{\hyperlink{namespaceinternal}{internal}}::is\_same<Scalar,\ typename\ OtherDerived::Scalar>::\mbox{\hyperlink{abseil-cpp_2absl_2container_2flat__hash__map__test_8cc_a54c2bae0f8aeed048a397b0618037252}{value}}),}
...
\DoxyCodeLine{00116\ \ \ }
\DoxyCodeLine{00117\ \ \ typename\ \mbox{\hyperlink{namespaceinternal}{internal}}::nested\_eval<ExpressionType,2>::type\ mat(\_expression());}
\DoxyCodeLine{00118\ \ \ typename\ \mbox{\hyperlink{namespaceinternal}{internal}}::nested\_eval<OtherDerived,2>::type\ vec(other.derived());}
\DoxyCodeLine{00119\ }
\DoxyCodeLine{00120\ \ \ CrossReturnType\ res(\_expression().rows(),\_expression().cols());}
\DoxyCodeLine{00121\ \ \ if(Direction==\mbox{\hyperlink{group__enums_ggad49a7b3738e273eb00932271b36127f7addca718e0564723df21d61b94b1198be}{Vertical}})}
\DoxyCodeLine{00122\ \ \ \{}
...
\DoxyCodeLine{00166\ \{}
\DoxyCodeLine{00167\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1plain__matrix__type}{plain\_matrix\_type<Derived>::type}}\ \mbox{\hyperlink{structEigen_1_1internal_1_1unitOrthogonal__selector_ab0b4d85807cf0c56975b4995588551fa}{VectorType}};}
\DoxyCodeLine{00168\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1traits}{traits<Derived>::Scalar}}\ \mbox{\hyperlink{structEigen_1_1internal_1_1unitOrthogonal__selector_a43415b1a62d0a0590961389a6ee74beb}{Scalar}};}
\DoxyCodeLine{00169\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1GenericNumTraits_abca8573812593670795c41f22aa9d5e2}{NumTraits<Scalar>::Real}}\ \mbox{\hyperlink{structEigen_1_1internal_1_1unitOrthogonal__selector_af0feeb407d3a335b831f606dc3383969}{RealScalar}};}
...
\DoxyCodeLine{00207\ \{}
\DoxyCodeLine{00208\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1plain__matrix__type}{plain\_matrix\_type<Derived>::type}}\ \mbox{\hyperlink{structEigen_1_1internal_1_1unitOrthogonal__selector_ab0b4d85807cf0c56975b4995588551fa}{VectorType}};}
