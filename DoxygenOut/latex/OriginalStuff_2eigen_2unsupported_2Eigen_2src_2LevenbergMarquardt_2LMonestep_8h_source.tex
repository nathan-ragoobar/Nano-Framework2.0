...
\hypertarget{OriginalStuff_2eigen_2unsupported_2Eigen_2src_2LevenbergMarquardt_2LMonestep_8h_source}{}\label{OriginalStuff_2eigen_2unsupported_2Eigen_2src_2LevenbergMarquardt_2LMonestep_8h_source}\index{OriginalStuff/eigen/unsupported/Eigen/src/LevenbergMarquardt/LMonestep.h@{OriginalStuff/eigen/unsupported/Eigen/src/LevenbergMarquardt/LMonestep.h}}
\mbox{\hyperlink{OriginalStuff_2eigen_2unsupported_2Eigen_2src_2LevenbergMarquardt_2LMonestep_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00021\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_a1347316132f0bd7bf2541788d9e12637}{LevenbergMarquardt<FunctorType>::minimizeOneStep}}(FVectorType\ \ \&x)}
\DoxyCodeLine{00022\ \{}
\DoxyCodeLine{00023\ \ \ \textcolor{keyword}{using\ }std::abs;}
\DoxyCodeLine{00024\ \ \ \textcolor{keyword}{using\ }std::sqrt;}
\DoxyCodeLine{00025\ \ \ RealScalar\ temp,\ temp1,temp2;\ }
\DoxyCodeLine{00026\ \ \ RealScalar\ ratio;\ }
\DoxyCodeLine{00027\ \ \ RealScalar\ pnorm,\ xnorm,\ fnorm1,\ actred,\ dirder,\ prered;}
\DoxyCodeLine{00028\ \ \ \mbox{\hyperlink{eigen_2Eigen_2src_2Core_2util_2Macros_8h_acaa7ba89800cfe18d5fd6eed620aea9c}{eigen\_assert}}(\mbox{\hyperlink{namespaceEigen_1_1numext_ac5e96d65e0b577673dd47bfe1068cdd9}{x}}.size()==\mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__test_8cc_a76f11d9a0a47b94f72c2d0e77fb32240}{n}});\ \textcolor{comment}{//\ check\ the\ caller\ is\ not\ cheating\ us}}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \ \ temp\ =\ 0.0;\ xnorm\ =\ 0.0;}
\DoxyCodeLine{00031\ \ \ \textcolor{comment}{/*\ calculate\ the\ jacobian\ matrix.\ */}}
\DoxyCodeLine{00032\ \ \ \mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ df\_ret\ =\ m\_functor.df(x,\ m\_fjac);}
...
\DoxyCodeLine{00041\ \ \ \textcolor{keywordflow}{for}\ (\textcolor{keywordtype}{int}\ j\ =\ 0;\ \mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}}\ <\ \mbox{\hyperlink{namespaceEigen_1_1numext_ac5e96d65e0b577673dd47bfe1068cdd9}{x}}.size();\ ++\mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}})}
\DoxyCodeLine{00042\ \ \ \ \ m\_wa2(j)\ =\ m\_fjac.col(j).blueNorm();}
\DoxyCodeLine{00043\ \ \ QRSolver\ qrfac(m\_fjac);}
...
\DoxyCodeLine{00056\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j\ =\ 0;\ \mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}}\ <\ \mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__test_8cc_a76f11d9a0a47b94f72c2d0e77fb32240}{n}};\ ++\mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}})}
\DoxyCodeLine{00057\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ m\_diag[j]\ =\ (m\_wa2[j]==0.)?\ 1.\ :\ m\_wa2[\mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}}];}
\DoxyCodeLine{00058\ }
...
\DoxyCodeLine{00076\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j\ =\ 0;\ \mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}}\ <\ \mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__test_8cc_a76f11d9a0a47b94f72c2d0e77fb32240}{n}};\ ++\mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}})}
...
\DoxyCodeLine{00096\ \ \ \ \ m\_wa2\ =\ \mbox{\hyperlink{namespaceEigen_1_1numext_ac5e96d65e0b577673dd47bfe1068cdd9}{x}}\ +\ m\_wa1;}
...
\DoxyCodeLine{00111\ \ \ \ \ \textcolor{keywordflow}{if}\ (Scalar(.1)\ *\ fnorm1\ <\ m\_fnorm)}
...
\DoxyCodeLine{00119\ \ \ \ \ prered\ =\ temp1\ +\ temp2\ /\ Scalar(.5);}
...
\DoxyCodeLine{00129\ \ \ \ \ \textcolor{keywordflow}{if}\ (ratio\ <=\ Scalar(.25))\ \{}
\DoxyCodeLine{00130\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (actred\ >=\ 0.)}
\DoxyCodeLine{00131\ \ \ \ \ \ \ \ \ \ \ \ \ temp\ =\ RealScalar(.5);}
\DoxyCodeLine{00132\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (actred\ <\ 0.)}
\DoxyCodeLine{00133\ \ \ \ \ \ \ \ \ \ \ \ \ temp\ =\ RealScalar(.5)\ *\ dirder\ /\ (dirder\ +\ RealScalar(.5)\ *\ actred);}
\DoxyCodeLine{00134\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (RealScalar(.1)\ *\ fnorm1\ >=\ m\_fnorm\ ||\ temp\ <\ RealScalar(.1))}
\DoxyCodeLine{00135\ \ \ \ \ \ \ \ \ \ \ \ \ temp\ =\ Scalar(.1);}
\DoxyCodeLine{00136\ \ \ \ \ \ \ \ \ \textcolor{comment}{/*\ Computing\ MIN\ */}}
\DoxyCodeLine{00137\ \ \ \ \ \ \ \ \ m\_delta\ =\ temp\ *\ (std::min)(m\_delta,\ pnorm\ /\ RealScalar(.1));}
\DoxyCodeLine{00138\ \ \ \ \ \ \ \ \ m\_par\ /=\ temp;}
\DoxyCodeLine{00139\ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (!(m\_par\ !=\ 0.\ \&\&\ ratio\ <\ RealScalar(.75)))\ \{}
\DoxyCodeLine{00140\ \ \ \ \ \ \ \ \ m\_delta\ =\ pnorm\ /\ RealScalar(.5);}
\DoxyCodeLine{00141\ \ \ \ \ \ \ \ \ m\_par\ =\ RealScalar(.5)\ *\ m\_par;}
\DoxyCodeLine{00142\ \ \ \ \ \}}
\DoxyCodeLine{00143\ }
\DoxyCodeLine{00144\ \ \ \ \ \textcolor{comment}{/*\ test\ for\ successful\ iteration.\ */}}
\DoxyCodeLine{00145\ \ \ \ \ \textcolor{keywordflow}{if}\ (ratio\ >=\ RealScalar(1e-\/4))\ \{}
\DoxyCodeLine{00146\ \ \ \ \ \ \ \ \ \textcolor{comment}{/*\ successful\ iteration.\ update\ x,\ m\_fvec,\ and\ their\ norms.\ */}}
\DoxyCodeLine{00147\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{namespaceEigen_1_1numext_ac5e96d65e0b577673dd47bfe1068cdd9}{x}}\ =\ m\_wa2;}
...
\DoxyCodeLine{00156\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a35560f7dbf19244fda7e463d14157c43}{abs}}(actred)\ <=\ m\_ftol\ \&\&\ prered\ <=\ m\_ftol\ \&\&\ Scalar(.5)\ *\ ratio\ <=\ 1.\ \&\&\ m\_delta\ <=\ m\_xtol\ *\ xnorm)}
\DoxyCodeLine{00157\ \ \ \ \ \{}
...
\DoxyCodeLine{00160\ \ \ \ \ \}}
\DoxyCodeLine{00161\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a35560f7dbf19244fda7e463d14157c43}{abs}}(actred)\ <=\ m\_ftol\ \&\&\ prered\ <=\ m\_ftol\ \&\&\ Scalar(.5)\ *\ ratio\ <=\ 1.)\ }
\DoxyCodeLine{00162\ \ \ \ \ \{}
...
\DoxyCodeLine{00177\ \ \ \ \ \}}
\DoxyCodeLine{00178\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a35560f7dbf19244fda7e463d14157c43}{abs}}(actred)\ <=\ NumTraits<Scalar>::epsilon()\ \&\&\ prered\ <=\ NumTraits<Scalar>::epsilon()\ \&\&\ Scalar(.5)\ *\ ratio\ <=\ 1.)}
\DoxyCodeLine{00179\ \ \ \ \ \{}
...
\DoxyCodeLine{00182\ \ \ \ \ \}}
\DoxyCodeLine{00183\ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_delta\ <=\ NumTraits<Scalar>::epsilon()\ *\ xnorm)\ }
\DoxyCodeLine{00184\ \ \ \ \ \{}
...
\DoxyCodeLine{00187\ \ \ \ \ \}}
\DoxyCodeLine{00188\ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_gnorm\ <=\ NumTraits<Scalar>::epsilon())}
\DoxyCodeLine{00189\ \ \ \ \ \{}
...
\DoxyCodeLine{00192\ \ \ \ \ \}}
\DoxyCodeLine{00193\ }
\DoxyCodeLine{00194\ \ \ \}\ \textcolor{keywordflow}{while}\ (ratio\ <\ Scalar(1e-\/4));}
\DoxyCodeLine{00195\ }
