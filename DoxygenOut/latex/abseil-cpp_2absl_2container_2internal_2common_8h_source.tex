...
\hypertarget{abseil-cpp_2absl_2container_2internal_2common_8h_source}{}\label{abseil-cpp_2absl_2container_2internal_2common_8h_source}\index{abseil-\/cpp/absl/container/internal/common.h@{abseil-\/cpp/absl/container/internal/common.h}}
\mbox{\hyperlink{abseil-cpp_2absl_2container_2internal_2common_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00029\ \textcolor{keyword}{struct\ }IsTransparent\ :\ std::false\_type\ \{\};}
\DoxyCodeLine{00030\ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ T>}
\DoxyCodeLine{00031\ \textcolor{keyword}{struct\ }IsTransparent<T,\ \mbox{\hyperlink{namespaceabsl}{absl}}::\mbox{\hyperlink{namespaceabsl_a5d24e222375f72da89ee76f10480f40c}{void\_t}}<typename\ T::is\_transparent>>}
\DoxyCodeLine{00032\ \ \ \ \ :\ std::true\_type\ \{\};}
\DoxyCodeLine{00033\ }
\DoxyCodeLine{00034\ \textcolor{keyword}{template}\ <\textcolor{keywordtype}{bool}\ is\_transparent>}
\DoxyCodeLine{00035\ \textcolor{keyword}{struct\ }KeyArg\ \{}
...
\DoxyCodeLine{00085\ \ \ \}}
\DoxyCodeLine{00086\ }
\DoxyCodeLine{00087\ \ \ \textcolor{keyword}{struct\ }construct\_tag\_t\ \{\};}
...
\DoxyCodeLine{00120\ \textcolor{keyword}{class\ }node\_handle\ :\ \textcolor{keyword}{public}\ node\_handle\_base<PolicyTraits,\ Alloc>\ \{}
\DoxyCodeLine{00121\ \ \ \textcolor{keyword}{using\ }Base\ =\ \mbox{\hyperlink{classabsl_1_1container__internal_1_1node__handle__base_a5aef9a151562a4ce2d693b8fd9e00437}{node\_handle\_base<PolicyTraits,\ Alloc>}};}
\DoxyCodeLine{00122\ }
...
\DoxyCodeLine{00141\ \ \ \textcolor{keyword}{using\ }Base\ =\ \mbox{\hyperlink{classabsl_1_1container__internal_1_1node__handle__base}{node\_handle\_base<PolicyTraits,\ Alloc>}};}
\DoxyCodeLine{00142\ \ \ \textcolor{keyword}{using\ }\mbox{\hyperlink{classabsl_1_1container__internal_1_1node__handle__base_a188282b2bfed158b21e5e87657d40506}{slot\_type}}\ =\ \textcolor{keyword}{typename}\ PolicyTraits::slot\_type;}
\DoxyCodeLine{00143\ }
...
\DoxyCodeLine{00197\ \textcolor{keyword}{struct\ }InsertReturnType\ \{}
