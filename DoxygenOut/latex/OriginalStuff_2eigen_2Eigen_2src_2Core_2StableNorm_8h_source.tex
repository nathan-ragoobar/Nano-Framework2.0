...
\hypertarget{OriginalStuff_2eigen_2Eigen_2src_2Core_2StableNorm_8h_source}{}\label{OriginalStuff_2eigen_2Eigen_2src_2Core_2StableNorm_8h_source}\index{OriginalStuff/eigen/Eigen/src/Core/StableNorm.h@{OriginalStuff/eigen/Eigen/src/Core/StableNorm.h}}
\mbox{\hyperlink{OriginalStuff_2eigen_2Eigen_2src_2Core_2StableNorm_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00026\ \ \ \ \ \textcolor{keywordflow}{if}(tmp\ >\ \mbox{\hyperlink{structEigen_1_1GenericNumTraits_ac8509669719a15051e933e0dc7efd3b6}{NumTraits<Scalar>::highest}}())}
\DoxyCodeLine{00027\ \ \ \ \ \{}
...
\DoxyCodeLine{00030\ \ \ \ \ \}}
\DoxyCodeLine{00031\ \ \ \ \ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}(maxCoeff>\mbox{\hyperlink{structEigen_1_1GenericNumTraits_ac8509669719a15051e933e0dc7efd3b6}{NumTraits<Scalar>::highest}}())\ \textcolor{comment}{//\ we\ got\ a\ INF}}
\DoxyCodeLine{00032\ \ \ \ \ \{}
...
\DoxyCodeLine{00058\ \ \ }
\DoxyCodeLine{00059\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1internal_1_1nested__eval_a865fb570fedaa74e0b5c84f04f1b8026}{internal::nested\_eval<VectorType,2>::type}}\ VectorTypeCopy;}
...
\DoxyCodeLine{00064\ \ \ \ \ CanAlign\ =\ (\ \ \ (\mbox{\hyperlink{namespacefineweb_a7ab32de24971f7d1f91cd2edca351e06}{int}}(VectorTypeCopyClean::Flags)\&\mbox{\hyperlink{group__flags_gabf1e9d0516a933445a4c307ad8f14915}{DirectAccessBit}})}
\DoxyCodeLine{00065\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ ||\ (\mbox{\hyperlink{namespacefineweb_a7ab32de24971f7d1f91cd2edca351e06}{int}}(internal::evaluator<VectorTypeCopyClean>::Alignment)>0)\ \textcolor{comment}{//\ FIXME\ Alignment)>0\ might\ not\ be\ enough}}
...
\DoxyCodeLine{00082\ \mbox{\hyperlink{namespaceEigen_1_1internal_a824c6e0e53d5685dd053d72e994f87ef}{stable\_norm\_impl}}(\textcolor{keyword}{const}\ VectorType\ \&vec,\ \textcolor{keyword}{typename}\ enable\_if<VectorType::IsVectorAtCompileTime>::type*\ =\ 0\ )}
\DoxyCodeLine{00083\ \{}
...
\DoxyCodeLine{00104\ \mbox{\hyperlink{namespaceEigen_1_1internal_a824c6e0e53d5685dd053d72e994f87ef}{stable\_norm\_impl}}(\textcolor{keyword}{const}\ MatrixType\ \&mat,\ \textcolor{keyword}{typename}\ enable\_if<!MatrixType::IsVectorAtCompileTime>::type*\ =\ 0\ )}
\DoxyCodeLine{00105\ \{}
...
\DoxyCodeLine{00112\ }
\DoxyCodeLine{00113\ \ \ \textcolor{keywordflow}{for}(\mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=0;\ \mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}}<mat.outerSize();\ ++\mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}})}
...
\DoxyCodeLine{00120\ \mbox{\hyperlink{namespaceEigen_1_1internal_ad5435f3387e943a41870d140ab0bfd63}{blueNorm\_impl}}(\textcolor{keyword}{const}\ EigenBase<Derived>\&\ \_vec)}
\DoxyCodeLine{00121\ \{}
...
\DoxyCodeLine{00153\ }
\DoxyCodeLine{00154\ \ \ \textcolor{keywordflow}{for}(\mbox{\hyperlink{namespaceEigen_a62e77e0933482dafde8fe197d9a2cfde}{Index}}\ j=0;\ \mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}}<vec.outerSize();\ ++\mbox{\hyperlink{namespaceabsl_adb6bd4a9012b471ac01613aff8d4d81ba363b122c528f54df4a0446b6bab05515}{j}})}
\DoxyCodeLine{00155\ \ \ \{}
...
\DoxyCodeLine{00196\ \ \ \ \ \textcolor{keywordflow}{return}\ abig\ *\ \mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a656b9217a2fcb6de59dc8d1eb3079cc7}{sqrt}}(RealScalar(1)\ +\ \mbox{\hyperlink{namespaceEigen_1_1numext_ad59216129a430099e97b4c4b1e2f2984}{numext::abs2}}(asml/abig));}
\DoxyCodeLine{00197\ \}}
\DoxyCodeLine{00198\ }
...
\DoxyCodeLine{00228\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ NumTraits<typename\ internal::traits<Derived>::Scalar>::Real}
...
\DoxyCodeLine{00240\ \textcolor{keyword}{inline}\ \textcolor{keyword}{typename}\ NumTraits<typename\ internal::traits<Derived>::Scalar>::Real}
...
\DoxyCodeLine{00246\ \ \ \ \ \textcolor{keywordflow}{return}\ this-\/>\mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2MatrixCwiseUnaryOps_8h_afaccb60c8e7e930b441a048374b64ea3}{cwiseAbs}}().redux(internal::scalar\_hypot\_op<RealScalar>());}
\DoxyCodeLine{00247\ \}}
\DoxyCodeLine{00248\ }
