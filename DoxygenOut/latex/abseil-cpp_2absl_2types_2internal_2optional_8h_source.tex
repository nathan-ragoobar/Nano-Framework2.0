...
\hypertarget{abseil-cpp_2absl_2types_2internal_2optional_8h_source}{}\label{abseil-cpp_2absl_2types_2internal_2optional_8h_source}\index{abseil-\/cpp/absl/types/internal/optional.h@{abseil-\/cpp/absl/types/internal/optional.h}}
\mbox{\hyperlink{abseil-cpp_2absl_2types_2internal_2optional_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00038\ \textcolor{keyword}{struct\ }init\_t\ \{}
...
\DoxyCodeLine{00048\ \textcolor{keyword}{class\ }optional\_data\_dtor\_base\ \{}
\DoxyCodeLine{00049\ \ \ \textcolor{keyword}{struct\ }dummy\_type\ \{}
\DoxyCodeLine{00050\ \ \ \ \ \textcolor{keyword}{static\_assert}(\textcolor{keyword}{sizeof}(T)\ \%\ \textcolor{keyword}{sizeof}(empty\_struct)\ ==\ 0,\ \textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{00051\ \ \ \ \ \textcolor{comment}{//\ Use\ an\ array\ to\ avoid\ GCC\ 6\ placement-\/new\ warning.}}
\DoxyCodeLine{00052\ \ \ \ \ empty\_struct\ data[\textcolor{keyword}{sizeof}(T)\ /\ \textcolor{keyword}{sizeof}(empty\_struct)];}
\DoxyCodeLine{00053\ \ \ \};}
\DoxyCodeLine{00054\ }
...
\DoxyCodeLine{00091\ \textcolor{keyword}{class\ }optional\_data\_dtor\_base<T,\ true>\ \{}
\DoxyCodeLine{00092\ \ \ \textcolor{keyword}{struct\ }dummy\_type\ \{}
\DoxyCodeLine{00093\ \ \ \ \ \textcolor{keyword}{static\_assert}(\textcolor{keyword}{sizeof}(T)\ \%\ \textcolor{keyword}{sizeof}(empty\_struct)\ ==\ 0,\ \textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{00094\ \ \ \ \ \textcolor{comment}{//\ Use\ array\ to\ avoid\ GCC\ 6\ placement-\/new\ warning.}}
\DoxyCodeLine{00095\ \ \ \ \ empty\_struct\ data[\textcolor{keyword}{sizeof}(T)\ /\ \textcolor{keyword}{sizeof}(empty\_struct)];}
\DoxyCodeLine{00096\ \ \ \};}
\DoxyCodeLine{00097\ }
\DoxyCodeLine{00098\ \ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00099\ \ \ \textcolor{comment}{//\ Whether\ there\ is\ data\ or\ not.}}
\DoxyCodeLine{00100\ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{classabsl_1_1optional__internal_1_1optional__data__dtor__base_3_01T_00_01true_01_4_a45ccc9d2f38a5dfb26b2fda559564a7b}{engaged\_}};}
\DoxyCodeLine{00101\ \ \ \textcolor{comment}{//\ Data\ storage}}
\DoxyCodeLine{00102\ \ \ \textcolor{keyword}{union\ }\{}
\DoxyCodeLine{00103\ \ \ \ \ T\ \mbox{\hyperlink{classabsl_1_1optional__internal_1_1optional__data__dtor__base_3_01T_00_01true_01_4_adcac5611259a83b2089ebeb5efa6482a}{data\_}};}
\DoxyCodeLine{00104\ \ \ \ \ dummy\_type\ \mbox{\hyperlink{classabsl_1_1optional__internal_1_1optional__data__dtor__base_3_01T_00_01true_01_4_a7ad4feff06d80f62edd5052f0430b04e}{dummy\_}};}
\DoxyCodeLine{00105\ \ \ \};}
...
\DoxyCodeLine{00117\ \textcolor{keyword}{class\ }optional\_data\_base\ :\ \textcolor{keyword}{public}\ optional\_data\_dtor\_base<T>\ \{}
...
\DoxyCodeLine{00149\ \textcolor{keyword}{class\ }optional\_data;}
\DoxyCodeLine{00150\ }
...
\DoxyCodeLine{00153\ \textcolor{keyword}{class\ }optional\_data<T,\ true>\ :\ \textcolor{keyword}{public}\ optional\_data\_base<T>\ \{}
\DoxyCodeLine{00154\ \ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00155\ \ \ \textcolor{keyword}{using\ }optional\_data\_base<T>::optional\_data\_base;}
\DoxyCodeLine{00156\ \};}
\DoxyCodeLine{00157\ }
\DoxyCodeLine{00158\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00159\ \textcolor{keyword}{class\ }optional\_data<T,\ false>\ :\ \textcolor{keyword}{public}\ optional\_data\_base<T>\ \{}
\DoxyCodeLine{00160\ \ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00161\ \ \ \textcolor{keyword}{using\ }optional\_data\_base<T>::optional\_data\_base;}
\DoxyCodeLine{00162\ }
...
\DoxyCodeLine{00207\ \textcolor{keyword}{class\ }optional\_ctor\_base;}
\DoxyCodeLine{00208\ }
\DoxyCodeLine{00209\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00210\ \textcolor{keyword}{class\ }optional\_ctor\_base<\mbox{\hyperlink{namespaceabsl_1_1optional__internal_a239888afd9358f38f08074701fb1e592}{copy\_traits}}::\mbox{\hyperlink{namespaceabsl_1_1optional__internal_a239888afd9358f38f08074701fb1e592a283e9ab6badb76002d4ed4be1277b021}{copyable}}>\ \{}
...
\DoxyCodeLine{00308\ \textcolor{keyword}{struct\ }is\_constructible\_convertible\_assignable\_from\_optional}
