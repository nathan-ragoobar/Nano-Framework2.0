...
\hypertarget{abseil-cpp_2absl_2synchronization_2internal_2graphcycles_8h_source}{}\label{abseil-cpp_2absl_2synchronization_2internal_2graphcycles_8h_source}\index{abseil-\/cpp/absl/synchronization/internal/graphcycles.h@{abseil-\/cpp/absl/synchronization/internal/graphcycles.h}}
\mbox{\hyperlink{abseil-cpp_2absl_2synchronization_2internal_2graphcycles_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00050\ \textcolor{keyword}{struct\ }GraphId\ \{}
...
\DoxyCodeLine{00058\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{structabsl_1_1synchronization__internal_1_1GraphId}{GraphId}}\ \mbox{\hyperlink{namespaceabsl_1_1synchronization__internal_ab3d8c7658be04e5d06ae41a09564067f}{InvalidGraphId}}()\ \{}
\DoxyCodeLine{00059\ \ \ \textcolor{keywordflow}{return}\ \mbox{\hyperlink{structabsl_1_1synchronization__internal_1_1GraphId}{GraphId}}\{0\};}
\DoxyCodeLine{00060\ \}}
\DoxyCodeLine{00061\ }
\DoxyCodeLine{00062\ \textcolor{keyword}{class\ }GraphCycles\ \{}
...
\DoxyCodeLine{00070\ \ \ GraphId\ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_a6313b110f799f6feb6e9da4ebcb3eb3e}{GetId}}(\textcolor{keywordtype}{void}*\ \mbox{\hyperlink{abseil-cpp_2absl_2base_2internal_2low__level__alloc__test_8cc_a935adc2e417a61d7eb6f04efb18ba031}{ptr}});}
\DoxyCodeLine{00071\ }
...
\DoxyCodeLine{00078\ \ \ \textcolor{keywordtype}{void}*\ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_a3e22940e953801cbdfab137f3ac33f32}{Ptr}}(GraphId\ \textcolor{keywordtype}{id});}
\DoxyCodeLine{00079\ }
...
\DoxyCodeLine{00083\ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_afa2247d27dec62e51e364194514bb316}{InsertEdge}}(GraphId\ source\_node,\ GraphId\ dest\_node);}
\DoxyCodeLine{00084\ }
\DoxyCodeLine{00085\ \ \ \textcolor{comment}{//\ Remove\ any\ edge\ that\ exists\ from\ source\_node\ to\ dest\_node.}}
\DoxyCodeLine{00086\ \ \ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_a6f7dff444613ec72c19d66b37dd1a08f}{RemoveEdge}}(GraphId\ source\_node,\ GraphId\ dest\_node);}
\DoxyCodeLine{00087\ }
\DoxyCodeLine{00088\ \ \ \textcolor{comment}{//\ Return\ whether\ node\ exists\ in\ the\ graph.}}
\DoxyCodeLine{00089\ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_a632fed5046de4206a57387049ef2a84b}{HasNode}}(GraphId\ node);}
\DoxyCodeLine{00090\ }
\DoxyCodeLine{00091\ \ \ \textcolor{comment}{//\ Return\ whether\ there\ is\ an\ edge\ directly\ from\ source\_node\ to\ dest\_node.}}
\DoxyCodeLine{00092\ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_a162c5b0a00d2e230fd1c7aed050e225b}{HasEdge}}(GraphId\ source\_node,\ GraphId\ dest\_node)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00093\ }
...
\DoxyCodeLine{00096\ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_ab2defaa1c81feaba5f8071f269e72663}{IsReachable}}(GraphId\ source\_node,\ GraphId\ dest\_node)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00097\ }
...
\DoxyCodeLine{00110\ \ \ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_a4236ffce0b5e5914f4d57fd5bc975ba4}{FindPath}}(GraphId\ source,\ GraphId\ dest,\ \textcolor{keywordtype}{int}\ max\_path\_len,}
\DoxyCodeLine{00111\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ GraphId\ path[])\ \textcolor{keyword}{const};}
\DoxyCodeLine{00112\ }
...
\DoxyCodeLine{00135\ \ \ \textcolor{keyword}{struct\ }Rep;}
\DoxyCodeLine{00136\ \ \textcolor{keyword}{private}:}
\DoxyCodeLine{00137\ \ \ Rep\ *rep\_;\ \ \ \ \ \ \textcolor{comment}{//\ opaque\ representation}}
\DoxyCodeLine{00138\ \ \ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_abfaca02a5a5dc155b374e2be60408ddf}{GraphCycles}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_abfaca02a5a5dc155b374e2be60408ddf}{GraphCycles}}\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00139\ \ \ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_abfaca02a5a5dc155b374e2be60408ddf}{GraphCycles}}\&\ operator=(\textcolor{keyword}{const}\ \mbox{\hyperlink{classabsl_1_1synchronization__internal_1_1GraphCycles_abfaca02a5a5dc155b374e2be60408ddf}{GraphCycles}}\&)\ =\ \textcolor{keyword}{delete};}
\DoxyCodeLine{00140\ \};}
\DoxyCodeLine{00141\ }
