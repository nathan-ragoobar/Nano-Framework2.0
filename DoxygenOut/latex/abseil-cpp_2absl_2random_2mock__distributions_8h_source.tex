...
\hypertarget{abseil-cpp_2absl_2random_2mock__distributions_8h_source}{}\label{abseil-cpp_2absl_2random_2mock__distributions_8h_source}\index{abseil-\/cpp/absl/random/mock\_distributions.h@{abseil-\/cpp/absl/random/mock\_distributions.h}}
\mbox{\hyperlink{abseil-cpp_2absl_2random_2mock__distributions_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00085\ \textcolor{keyword}{using\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{MockUniform}}\ =\ \mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{random\_internal::MockOverloadSetWithValidator}}<}
\DoxyCodeLine{00086\ \ \ \ \ \mbox{\hyperlink{structabsl_1_1random__internal_1_1UniformDistributionWrapper}{random\_internal::UniformDistributionWrapper<R>}},}
\DoxyCodeLine{00087\ \ \ \ \ \mbox{\hyperlink{classabsl_1_1random__internal_1_1UniformDistributionValidator}{random\_internal::UniformDistributionValidator<R>}},}
\DoxyCodeLine{00088\ \ \ \ \ R(\mbox{\hyperlink{structabsl_1_1IntervalClosedOpenTag}{IntervalClosedOpenTag}},\ \mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ R,\ R),}
\DoxyCodeLine{00089\ \ \ \ \ R(\mbox{\hyperlink{structabsl_1_1IntervalClosedClosedTag}{IntervalClosedClosedTag}},\ \mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ R,\ R),}
\DoxyCodeLine{00090\ \ \ \ \ R(\mbox{\hyperlink{structabsl_1_1IntervalOpenOpenTag}{IntervalOpenOpenTag}},\ \mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ R,\ R),}
\DoxyCodeLine{00091\ \ \ \ \ R(\mbox{\hyperlink{structabsl_1_1IntervalOpenClosedTag}{IntervalOpenClosedTag}},\ \mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ R,\ R),\ R(\mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ R,\ R),}
\DoxyCodeLine{00092\ \ \ \ \ R(\mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&)>;}
\DoxyCodeLine{00093\ }
...
\DoxyCodeLine{00112\ \textcolor{keyword}{using\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{MockBernoulli}}\ =}
\DoxyCodeLine{00113\ \ \ \ \ \mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{random\_internal::MockOverloadSet}}<\mbox{\hyperlink{classabsl_1_1bernoulli__distribution}{absl::bernoulli\_distribution}},}
\DoxyCodeLine{00114\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ bool(\mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ \textcolor{keywordtype}{double})>;}
\DoxyCodeLine{00115\ }
...
\DoxyCodeLine{00136\ \textcolor{keyword}{using\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{MockBeta}}\ =}
\DoxyCodeLine{00137\ \ \ \ \ \mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{random\_internal::MockOverloadSet<absl::beta\_distribution<RealType>}},}
\DoxyCodeLine{00138\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ RealType(\mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ RealType,}
...
\DoxyCodeLine{00162\ \textcolor{keyword}{using\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{MockExponential}}\ =}
\DoxyCodeLine{00163\ \ \ \ \ \mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{random\_internal::MockOverloadSet<absl::exponential\_distribution<RealType>}},}
\DoxyCodeLine{00164\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ RealType(\mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ RealType)>;}
\DoxyCodeLine{00165\ }
...
\DoxyCodeLine{00187\ \textcolor{keyword}{using\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{MockGaussian}}\ =}
\DoxyCodeLine{00188\ \ \ \ \ \mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{random\_internal::MockOverloadSet<absl::gaussian\_distribution<RealType>}},}
\DoxyCodeLine{00189\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ RealType(\mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ RealType,}
...
\DoxyCodeLine{00213\ \textcolor{keyword}{using\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{MockLogUniform}}\ =\ \mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{random\_internal::MockOverloadSet}}<}
...
\DoxyCodeLine{00215\ \ \ \ \ IntType(\mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ IntType,\ IntType,\ IntType)>;}
\DoxyCodeLine{00216\ }
...
\DoxyCodeLine{00237\ \textcolor{keyword}{using\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{MockPoisson}}\ =}
\DoxyCodeLine{00238\ \ \ \ \ \mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{random\_internal::MockOverloadSet<absl::poisson\_distribution<IntType>}},}
\DoxyCodeLine{00239\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ IntType(\mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ \textcolor{keywordtype}{double})>;}
\DoxyCodeLine{00240\ }
...
\DoxyCodeLine{00261\ \textcolor{keyword}{using\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{MockZipf}}\ =}
\DoxyCodeLine{00262\ \ \ \ \ \mbox{\hyperlink{structabsl_1_1random__internal_1_1MockOverloadSetWithValidator}{random\_internal::MockOverloadSet<absl::zipf\_distribution<IntType>}},}
\DoxyCodeLine{00263\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ IntType(\mbox{\hyperlink{classabsl_1_1random__internal_1_1MockingBitGenImpl}{MockingBitGen}}\&,\ IntType,\ \textcolor{keywordtype}{double},}
