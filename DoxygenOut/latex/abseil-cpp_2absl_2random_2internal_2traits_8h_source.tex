...
\hypertarget{abseil-cpp_2absl_2random_2internal_2traits_8h_source}{}\label{abseil-cpp_2absl_2random_2internal_2traits_8h_source}\index{abseil-\/cpp/absl/random/internal/traits.h@{abseil-\/cpp/absl/random/internal/traits.h}}
\mbox{\hyperlink{abseil-cpp_2absl_2random_2internal_2traits_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00040\ \textcolor{keyword}{class\ }is\_widening\_convertible\ \{}
...
\DoxyCodeLine{00067\ \textcolor{keyword}{struct\ }IsIntegral<\mbox{\hyperlink{namespaceabsl}{absl}}::\mbox{\hyperlink{classabsl_1_1int128}{int128}}>\ :\ std::true\_type\ \{\};}
\DoxyCodeLine{00068\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00069\ \textcolor{keyword}{struct\ }IsIntegral<\mbox{\hyperlink{namespaceabsl}{absl}}::uint128>\ :\ std::true\_type\ \{\};}
\DoxyCodeLine{00070\ }
\DoxyCodeLine{00071\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00072\ \textcolor{keyword}{struct\ }MakeUnsigned\ :\ std::make\_unsigned<T>\ \{\};}
\DoxyCodeLine{00073\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00074\ \textcolor{keyword}{struct\ }MakeUnsigned<\mbox{\hyperlink{namespaceabsl}{absl}}::int128>\ \{}
...
\DoxyCodeLine{00085\ \textcolor{keyword}{struct\ }IsUnsigned<\mbox{\hyperlink{namespaceabsl}{absl}}::\mbox{\hyperlink{classabsl_1_1int128}{int128}}>\ :\ std::false\_type\ \{\};}
\DoxyCodeLine{00086\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00087\ \textcolor{keyword}{struct\ }IsUnsigned<\mbox{\hyperlink{namespaceabsl}{absl}}::uint128>\ :\ std::true\_type\ \{\};}
\DoxyCodeLine{00088\ }
...
\DoxyCodeLine{00092\ \textcolor{keyword}{struct\ }unsigned\_bits;}
\DoxyCodeLine{00093\ }
\DoxyCodeLine{00094\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00095\ \textcolor{keyword}{struct\ }unsigned\_bits<8>\ \{}
