...
\hypertarget{abseil-cpp_2absl_2base_2internal_2invoke_8h_source}{}\label{abseil-cpp_2absl_2base_2internal_2invoke_8h_source}\index{abseil-\/cpp/absl/base/internal/invoke.h@{abseil-\/cpp/absl/base/internal/invoke.h}}
\mbox{\hyperlink{abseil-cpp_2absl_2base_2internal_2invoke_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00082\ \textcolor{keyword}{struct\ }StrippedAccept\ \{}
\DoxyCodeLine{00083\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{00084\ \ \ \textcolor{keyword}{struct\ }Accept\ :\ Derived::template\ AcceptImpl<typename\ std::remove\_cv<}
...
\DoxyCodeLine{00091\ \textcolor{keyword}{struct\ }MemFunAndRef\ :\ StrippedAccept<MemFunAndRef>\ \{}
\DoxyCodeLine{00092\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{00093\ \ \ \textcolor{keyword}{struct\ }AcceptImpl\ :\ std::false\_type\ \{\};}
\DoxyCodeLine{00094\ }
...
\DoxyCodeLine{00096\ \ \ \textcolor{keyword}{struct\ }AcceptImpl<MemFunType\ \mbox{\hyperlink{abseil-cpp_2absl_2hash_2internal_2city__test_8cc_ac54ae397901fe700628cafadea3c5208}{C}}::*,\ Obj,\ Args...>}
...
\DoxyCodeLine{00122\ \textcolor{keyword}{struct\ }MemFunAndPtr\ :\ StrippedAccept<MemFunAndPtr>\ \{}
\DoxyCodeLine{00123\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{00124\ \ \ \textcolor{keyword}{struct\ }AcceptImpl\ :\ std::false\_type\ \{\};}
\DoxyCodeLine{00125\ }
...
\DoxyCodeLine{00127\ \ \ \textcolor{keyword}{struct\ }AcceptImpl<MemFunType\ \mbox{\hyperlink{abseil-cpp_2absl_2hash_2internal_2city__test_8cc_ac54ae397901fe700628cafadea3c5208}{C}}::*,\ Ptr,\ Args...>}
...
\DoxyCodeLine{00144\ \textcolor{keyword}{struct\ }DataMemAndRef\ :\ StrippedAccept<DataMemAndRef>\ \{}
\DoxyCodeLine{00145\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{00146\ \ \ \textcolor{keyword}{struct\ }AcceptImpl\ :\ std::false\_type\ \{\};}
\DoxyCodeLine{00147\ }
...
\DoxyCodeLine{00149\ \ \ \textcolor{keyword}{struct\ }AcceptImpl<R\ \mbox{\hyperlink{abseil-cpp_2absl_2hash_2internal_2city__test_8cc_ac54ae397901fe700628cafadea3c5208}{C}}::*,\ Obj>}
...
\DoxyCodeLine{00162\ \textcolor{keyword}{struct\ }DataMemAndPtr\ :\ StrippedAccept<DataMemAndPtr>\ \{}
\DoxyCodeLine{00163\ \ \ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}...\ Args>}
\DoxyCodeLine{00164\ \ \ \textcolor{keyword}{struct\ }AcceptImpl\ :\ std::false\_type\ \{\};}
\DoxyCodeLine{00165\ }
...
\DoxyCodeLine{00167\ \ \ \textcolor{keyword}{struct\ }AcceptImpl<R\ \mbox{\hyperlink{abseil-cpp_2absl_2hash_2internal_2city__test_8cc_ac54ae397901fe700628cafadea3c5208}{C}}::*,\ Ptr>}
...
\DoxyCodeLine{00179\ \textcolor{keyword}{struct\ }Callable\ \{}
...
\DoxyCodeLine{00191\ \textcolor{keyword}{struct\ }Invoker\ \{}
\DoxyCodeLine{00192\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ std::conditional<}
\DoxyCodeLine{00193\ \ \ \ \ \ \ MemFunAndRef::Accept<Args...>\mbox{\hyperlink{abseil-cpp_2absl_2container_2flat__hash__map__test_8cc_a54c2bae0f8aeed048a397b0618037252}{::value}},\ MemFunAndRef,}
\DoxyCodeLine{00194\ \ \ \ \ \ \ \textcolor{keyword}{typename}\ std::conditional<}
\DoxyCodeLine{00195\ \ \ \ \ \ \ \ \ \ \ MemFunAndPtr::Accept<Args...>\mbox{\hyperlink{abseil-cpp_2absl_2container_2flat__hash__map__test_8cc_a54c2bae0f8aeed048a397b0618037252}{::value}},\ MemFunAndPtr,}
\DoxyCodeLine{00196\ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{typename}\ std::conditional<}
\DoxyCodeLine{00197\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ DataMemAndRef::Accept<Args...>\mbox{\hyperlink{abseil-cpp_2absl_2container_2flat__hash__map__test_8cc_a54c2bae0f8aeed048a397b0618037252}{::value}},\ DataMemAndRef,}
...
\DoxyCodeLine{00199\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ DataMemAndPtr,\ Callable>\mbox{\hyperlink{structabsl_1_1base__internal_1_1Invoker_aaac365d50818fd31cd123e7b962edcda}{::type}}>\mbox{\hyperlink{structabsl_1_1base__internal_1_1Invoker_aaac365d50818fd31cd123e7b962edcda}{::type}}>::}
...
\DoxyCodeLine{00217\ \textcolor{keyword}{struct\ }IsInvocableRImpl\ :\ std::false\_type\ \{\};}
\DoxyCodeLine{00218\ }
...
\DoxyCodeLine{00220\ \textcolor{keyword}{struct\ }IsInvocableRImpl<}
