...
\hypertarget{abseil-cpp_2absl_2strings_2internal_2cordz__handle_8h_source}{}\label{abseil-cpp_2absl_2strings_2internal_2cordz__handle_8h_source}\index{abseil-\/cpp/absl/strings/internal/cordz\_handle.h@{abseil-\/cpp/absl/strings/internal/cordz\_handle.h}}
\mbox{\hyperlink{abseil-cpp_2absl_2strings_2internal_2cordz__handle_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00035\ \textcolor{keyword}{class\ }\mbox{\hyperlink{abseil-cpp_2absl_2base_2config_8h_a806e23ebe4fd3a16cd6d752dc7931c77}{ABSL\_DLL}}\ CordzHandle\ \{}
...
\DoxyCodeLine{00050\ \ \ \textcolor{keywordtype}{bool}\ SafeToDelete()\ \textcolor{keyword}{const};}
\DoxyCodeLine{00051\ }
...
\DoxyCodeLine{00055\ \ \ \textcolor{keyword}{static}\ \textcolor{keywordtype}{void}\ Delete(\mbox{\hyperlink{classabsl_1_1cord__internal_1_1CordzHandle}{CordzHandle}}*\ handle);}
\DoxyCodeLine{00056\ }
\DoxyCodeLine{00057\ \ \ \textcolor{comment}{//\ Returns\ the\ current\ entries\ in\ the\ delete\ queue\ in\ LIFO\ order.}}
\DoxyCodeLine{00058\ \ \ \textcolor{keyword}{static}\ std::vector<const\ CordzHandle*>\ DiagnosticsGetDeleteQueue();}
\DoxyCodeLine{00059\ }
...
\DoxyCodeLine{00064\ \ \ \textcolor{keywordtype}{bool}\ DiagnosticsHandleIsSafeToInspect(\textcolor{keyword}{const}\ \mbox{\hyperlink{classabsl_1_1cord__internal_1_1CordzHandle}{CordzHandle}}*\ handle)\ \textcolor{keyword}{const};}
\DoxyCodeLine{00065\ }
...
\DoxyCodeLine{00073\ \ \ std::vector<const\ CordzHandle*>\ DiagnosticsGetSafeToInspectDeletedHandles();}
\DoxyCodeLine{00074\ }
\DoxyCodeLine{00075\ \ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00076\ \ \ \textcolor{keyword}{explicit}\ \mbox{\hyperlink{classabsl_1_1cord__internal_1_1CordzHandle}{CordzHandle}}(\textcolor{keywordtype}{bool}\ is\_snapshot);}
\DoxyCodeLine{00077\ \ \ \textcolor{keyword}{virtual}\ \mbox{\hyperlink{classabsl_1_1cord__internal_1_1CordzHandle}{\string~CordzHandle}}();}
\DoxyCodeLine{00078\ }
...
\DoxyCodeLine{00087\ \};}
\DoxyCodeLine{00088\ }
\DoxyCodeLine{00089\ \textcolor{keyword}{class\ }CordzSnapshot\ :\ \textcolor{keyword}{public}\ CordzHandle\ \{}
