...
\hypertarget{OriginalStuff_2eigen_2unsupported_2Eigen_2src_2IterativeSolvers_2ConstrainedConjGrad_8h_source}{}\label{OriginalStuff_2eigen_2unsupported_2Eigen_2src_2IterativeSolvers_2ConstrainedConjGrad_8h_source}\index{OriginalStuff/eigen/unsupported/Eigen/src/IterativeSolvers/ConstrainedConjGrad.h@{OriginalStuff/eigen/unsupported/Eigen/src/IterativeSolvers/ConstrainedConjGrad.h}}
\mbox{\hyperlink{OriginalStuff_2eigen_2unsupported_2Eigen_2src_2IterativeSolvers_2ConstrainedConjGrad_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00028\ }
\DoxyCodeLine{00029\ \textcolor{preprocessor}{\#include\ "{}\mbox{\hyperlink{OriginalStuff_2eigen_2Eigen_2src_2Core_2util_2NonMPL2_8h}{../../../../Eigen/src/Core/util/NonMPL2.h}}"{}}}
\DoxyCodeLine{00030\ }
...
\DoxyCodeLine{00060\ }
\DoxyCodeLine{00061\ \ \ \textcolor{keyword}{typedef}\ Triplet<double>\ T;}
...
\DoxyCodeLine{00107\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ VectorB\&\ \mbox{\hyperlink{abseil-cpp_2absl_2container_2internal_2layout__test_8cc_ad66453096871179e6c6effe0df4b483b}{b}},\ \textcolor{keyword}{const}\ VectorF\&\ f,\ IterationController\ \&iter)}
\DoxyCodeLine{00108\ \{}
...
\DoxyCodeLine{00112\ \ \ \textcolor{keyword}{typedef}\ Matrix<Scalar,Dynamic,1>\ \ TmpVec;}
\DoxyCodeLine{00113\ }
...
\DoxyCodeLine{00121\ \ \ iter.setRhsNorm(\mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a656b9217a2fcb6de59dc8d1eb3079cc7}{sqrt}}(\mbox{\hyperlink{abseil-cpp_2absl_2container_2internal_2layout__test_8cc_ad66453096871179e6c6effe0df4b483b}{b}}.dot(\mbox{\hyperlink{abseil-cpp_2absl_2container_2internal_2layout__test_8cc_ad66453096871179e6c6effe0df4b483b}{b}})));\ \textcolor{comment}{//\ gael\ vect\_sp(PS,\ b,\ b)}}
\DoxyCodeLine{00122\ \ \ \textcolor{keywordflow}{if}\ (iter.rhsNorm()\ ==\ 0.0)\ iter.setRhsNorm(1.0);}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00124\ \ \ SparseMatrix<Scalar,RowMajor>\ CINV(\mbox{\hyperlink{abseil-cpp_2absl_2hash_2internal_2city__test_8cc_ac54ae397901fe700628cafadea3c5208}{C}}.rows(),\ \mbox{\hyperlink{abseil-cpp_2absl_2hash_2internal_2city__test_8cc_ac54ae397901fe700628cafadea3c5208}{C}}.cols());}
...
\DoxyCodeLine{00145\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00146\ \ \ \ \ \ \ \ \ Scalar\ bb\ =\ CINV.row(\mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__benchmark_8cc_a717c50cfde3924051c279a89096afd3d}{i}}).dot(z);}
...
\DoxyCodeLine{00159\ }
\DoxyCodeLine{00160\ \ \ \ \ \textcolor{keywordflow}{if}\ (iter.finished(rho))\ \textcolor{keywordflow}{break};}
\DoxyCodeLine{00161\ \ \ \ \ \textcolor{keywordflow}{if}\ (transition\ ||\ iter.first())\ gamma\ =\ 0.0;}
