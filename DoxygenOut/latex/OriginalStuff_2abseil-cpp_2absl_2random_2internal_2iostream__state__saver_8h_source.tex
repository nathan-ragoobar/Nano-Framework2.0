...
\hypertarget{OriginalStuff_2abseil-cpp_2absl_2random_2internal_2iostream__state__saver_8h_source}{}\label{OriginalStuff_2abseil-cpp_2absl_2random_2internal_2iostream__state__saver_8h_source}\index{OriginalStuff/abseil-\/cpp/absl/random/internal/iostream\_state\_saver.h@{OriginalStuff/abseil-\/cpp/absl/random/internal/iostream\_state\_saver.h}}
\mbox{\hyperlink{OriginalStuff_2abseil-cpp_2absl_2random_2internal_2iostream__state__saver_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00032\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classabsl_1_1random__internal_1_1null__state__saver}{null\_state\_saver}}\ \{}
...
\DoxyCodeLine{00045\ \textcolor{keyword}{class\ }\mbox{\hyperlink{classabsl_1_1random__internal_1_1ostream__state__saver}{ostream\_state\_saver}}\ \{}
...
\DoxyCodeLine{00082\ ostream\_state\_saver<std::basic\_ostream<CharT,\ Traits>>\ \mbox{\hyperlink{namespaceabsl_1_1random__internal_a04da1d5318d386d8186b77635581772e}{make\_ostream\_state\_saver}}(}
...
\DoxyCodeLine{00089\ \ \ \textcolor{keyword}{using\ }result\_type\ =\ ostream\_state\_saver<std::basic\_ostream<CharT,\ Traits>>;}
...
\DoxyCodeLine{00099\ \ \ \textcolor{keyword}{using\ }result\_type\ =\ null\_state\_saver<T>;}
...
\DoxyCodeLine{00107\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1stream__precision__helper}{stream\_precision\_helper}}\ \{}
...
\DoxyCodeLine{00112\ \ \ \ \ \ \ \ \ \ \ :\ (std::numeric\_limits<T>::digits10\ +\ 3);}
\DoxyCodeLine{00113\ \};}
\DoxyCodeLine{00114\ }
...
\DoxyCodeLine{00149\ istream\_state\_saver<std::basic\_istream<CharT,\ Traits>>\ \mbox{\hyperlink{namespaceabsl_1_1random__internal_a8cbee2e68d48599a1d2fe727d31a4cc7}{make\_istream\_state\_saver}}(}
...
\DoxyCodeLine{00154\ \ \ \textcolor{keyword}{using\ }result\_type\ =\ istream\_state\_saver<std::basic\_istream<CharT,\ Traits>>;}
...
\DoxyCodeLine{00163\ \ \ \textcolor{keyword}{using\ }result\_type\ =\ null\_state\_saver<T>;}
...
\DoxyCodeLine{00174\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1stream__format__type}{stream\_format\_type}}}
...
\DoxyCodeLine{00181\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1stream__u128__helper}{stream\_u128\_helper}};}
\DoxyCodeLine{00182\ }
\DoxyCodeLine{00183\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00184\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structabsl_1_1random__internal_1_1stream__u128__helper}{stream\_u128\_helper}}<\mbox{\hyperlink{namespaceabsl}{absl}}::\mbox{\hyperlink{classabsl_1_1uint128}{uint128}}>\ \{}
...
\DoxyCodeLine{00222\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{namespaceabsl_1_1strings__internal_a3df6a3608b6026ccc227f94ffa8282aa}{FloatType}}\ \mbox{\hyperlink{namespaceabsl_1_1random__internal_a59f357f5be30c3730184c7336dc65bb2}{read\_floating\_point}}(IStream\&\ is)\ \{}
\DoxyCodeLine{00223\ \ \ \textcolor{keyword}{static\_assert}(std::is\_floating\_point<FloatType>::value,\ \textcolor{stringliteral}{"{}"{}});}
\DoxyCodeLine{00224\ \ \ \mbox{\hyperlink{namespaceabsl_1_1strings__internal_a3df6a3608b6026ccc227f94ffa8282aa}{FloatType}}\ dest;}
