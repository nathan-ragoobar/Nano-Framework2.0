...
\hypertarget{llmc_2tokenizer_8h_source}{}\label{llmc_2tokenizer_8h_source}\index{llmc/tokenizer.h@{llmc/tokenizer.h}}
\mbox{\hyperlink{llmc_2tokenizer_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00023\ \ \ \ \ \textcolor{keywordtype}{char}\ **\mbox{\hyperlink{structTokenizer_ae6c8f2ec0c0e0dead4ad975951540b67}{token\_table}};}
...
\DoxyCodeLine{00027\ }
\DoxyCodeLine{00028\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{llmc_2tokenizer_8h_ac78b869a7e4dff7a7f33aa548c248acf}{safe\_printf}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *piece)\ \{}
...
\DoxyCodeLine{00042\ \}}
\DoxyCodeLine{00043\ }
\DoxyCodeLine{00044\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{llmc_2tokenizer_8h_ad4e8c42503c3a216d7d7a19495a4ffdc}{tokenizer\_init}}(\mbox{\hyperlink{structTokenizer}{Tokenizer}}\ *tokenizer,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *filename)\ \{}
...
\DoxyCodeLine{00058\ \ \ \ \ \mbox{\hyperlink{llmc_2utils_8h_aeaeb423fa1a9bddb0cf4c1e0120b09ee}{freadCheck}}(\mbox{\hyperlink{abseil-cpp_2absl_2base_2internal_2low__level__alloc_8cc_a85861428b812bc81bc5362c43c423cbd}{header}},\ \textcolor{keyword}{sizeof}(uint32\_t),\ 256,\ file);}
...
\DoxyCodeLine{00077\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{llmc_2utils_8h_aeaeb423fa1a9bddb0cf4c1e0120b09ee}{freadCheck}}(\&length,\ \textcolor{keyword}{sizeof}(\textcolor{keywordtype}{unsigned}\ \textcolor{keywordtype}{char}),\ 1,\ file);}
\DoxyCodeLine{00078\ \ \ \ \ \ \ \ \ assert(length\ >\ 0);\ \textcolor{comment}{//\ every\ token\ should\ be\ at\ least\ one\ character}}
\DoxyCodeLine{00079\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{char}\ *token\_bytes\ =\ (\textcolor{keywordtype}{char}\ *)\mbox{\hyperlink{llmc_2utils_8h_a4be764aabd56cde98ff89be72c51a128}{mallocCheck}}(length\ +\ 1);}
\DoxyCodeLine{00080\ \ \ \ \ \ \ \ \ \mbox{\hyperlink{llmc_2utils_8h_aeaeb423fa1a9bddb0cf4c1e0120b09ee}{freadCheck}}(token\_bytes,\ \textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}),\ length,\ file);}
...
\DoxyCodeLine{00082\ \ \ \ \ \ \ \ \ tokenizer-\/>\mbox{\hyperlink{structTokenizer_ae6c8f2ec0c0e0dead4ad975951540b67}{token\_table}}[\mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__benchmark_8cc_a717c50cfde3924051c279a89096afd3d}{i}}]\ =\ token\_bytes;}
\DoxyCodeLine{00083\ \ \ \ \ \}}
\DoxyCodeLine{00084\ \ \ \ \ \textcolor{comment}{//\ cleanups}}
\DoxyCodeLine{00085\ \ \ \ \ \mbox{\hyperlink{llmc_2utils_8h_ae094d98ede0500b8f5acba043487a5c1}{fcloseCheck}}(file);}
\DoxyCodeLine{00086\ \ \ \ \ tokenizer-\/>\mbox{\hyperlink{structTokenizer_a9a75e9498db50dbf291cd1609d28a4e6}{init\_ok}}\ =\ 1;}
\DoxyCodeLine{00087\ \}}
\DoxyCodeLine{00088\ }
\DoxyCodeLine{00089\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\mbox{\hyperlink{llmc_2tokenizer_8h_ae7ab7be3a4e2e231ef6e250b40f3860a}{tokenizer\_decode}}(\mbox{\hyperlink{structTokenizer}{Tokenizer}}\ *tokenizer,\ uint32\_t\ token\_id)\ \{}
...
\DoxyCodeLine{00094\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ tokenizer-\/>\mbox{\hyperlink{structTokenizer_ae6c8f2ec0c0e0dead4ad975951540b67}{token\_table}}[token\_id];}
...
\DoxyCodeLine{00099\ \}}
\DoxyCodeLine{00100\ }
\DoxyCodeLine{00101\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{llmc_2tokenizer_8h_a1ad5d732e055fb3781fd817049d6cd09}{tokenizer\_free}}(\mbox{\hyperlink{structTokenizer}{Tokenizer}}\ *tokenizer)\ \{}
...
\DoxyCodeLine{00104\ \ \ \ \ \ \ \ \ \ \ \ \ free(tokenizer-\/>\mbox{\hyperlink{structTokenizer_ae6c8f2ec0c0e0dead4ad975951540b67}{token\_table}}[\mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__benchmark_8cc_a717c50cfde3924051c279a89096afd3d}{i}}]);}
\DoxyCodeLine{00105\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00106\ \ \ \ \ \ \ \ \ free(tokenizer-\/>\mbox{\hyperlink{structTokenizer_ae6c8f2ec0c0e0dead4ad975951540b67}{token\_table}});}
\DoxyCodeLine{00107\ \ \ \ \ \}}
\DoxyCodeLine{00108\ \}}
\DoxyCodeLine{00109\ }
\DoxyCodeLine{00110\ }
