...
\hypertarget{OriginalStuff_2dev_2unistd_8h_source}{}\label{OriginalStuff_2dev_2unistd_8h_source}\index{OriginalStuff/dev/unistd.h@{OriginalStuff/dev/unistd.h}}
\mbox{\hyperlink{OriginalStuff_2dev_2unistd_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00020\ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{dev_2unistd_8h_a0c9810eb5ce71a66cee54725d6653852}{clock\_gettime}}(\textcolor{keywordtype}{int}\ ignore\_variable,\ \textcolor{keyword}{struct}\ timespec*\ tv)}
\DoxyCodeLine{00021\ \{}
...
\DoxyCodeLine{00037\ \ \ \ \ \textcolor{keywordtype}{char}\ **\mbox{\hyperlink{structglob__t_a3265051b3f19f438711c2b7699e475b7}{gl\_pathv}};\ \ \ \ \textcolor{comment}{//\ List\ of\ matched\ pathnames}}
\DoxyCodeLine{00038\ \}\ \mbox{\hyperlink{dev_2unistd_8h_aa907f6e454bbfb0fd8b3e3f922687789}{glob\_t}};}
\DoxyCodeLine{00039\ }
\DoxyCodeLine{00040\ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{dev_2unistd_8h_a1f50f6db3bdb127284ca1800d27c9afb}{replace\_forward\_slashes}}(\textcolor{keywordtype}{char}*\ str)\ \{}
...
\DoxyCodeLine{00047\ \}}
\DoxyCodeLine{00048\ }
\DoxyCodeLine{00049\ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{dev_2unistd_8h_a6c3709ad9d7a7e8112402130713bcfbe}{globfree}}(\mbox{\hyperlink{structglob__t}{glob\_t}}\ *pglob)\ \{}
...
\DoxyCodeLine{00051\ \ \ \ \ \ \ \ \ free(pglob-\/>\mbox{\hyperlink{structglob__t_a3265051b3f19f438711c2b7699e475b7}{gl\_pathv}}[\mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__benchmark_8cc_a717c50cfde3924051c279a89096afd3d}{i}}]);\ \textcolor{comment}{//\ Free\ the\ allocated\ memory\ for\ each\ filename}}
\DoxyCodeLine{00052\ \ \ \ \ \}}
\DoxyCodeLine{00053\ \ \ \ \ free(pglob-\/>\mbox{\hyperlink{structglob__t_a3265051b3f19f438711c2b7699e475b7}{gl\_pathv}});\ \textcolor{comment}{//\ Free\ the\ allocated\ memory\ for\ the\ list\ of\ filenames}}
\DoxyCodeLine{00054\ \}}
\DoxyCodeLine{00055\ }
\DoxyCodeLine{00056\ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{dev_2unistd_8h_a27d024aa0a7573e3454274b5583cb4ad}{glob}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ pattern,\ \textcolor{keywordtype}{int}\ ignored\_flags,\ \textcolor{keywordtype}{int}\ (*ignored\_errfunc)(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ epath,\ \textcolor{keywordtype}{int}\ eerrno),\ \mbox{\hyperlink{structglob__t}{glob\_t}}*\ pglob)\{}
...
\DoxyCodeLine{00063\ }
\DoxyCodeLine{00064\ \ \ \ \ \mbox{\hyperlink{dev_2unistd_8h_a1f50f6db3bdb127284ca1800d27c9afb}{replace\_forward\_slashes}}\ (pattern\_copy);\ \textcolor{comment}{//\ Replace\ forward\ slashes\ with\ backslashes}}
\DoxyCodeLine{00065\ }
...
\DoxyCodeLine{00080\ }
\DoxyCodeLine{00081\ \ \ \ \ pglob-\/>\mbox{\hyperlink{structglob__t_a3265051b3f19f438711c2b7699e475b7}{gl\_pathv}}\ =\ (\textcolor{keywordtype}{char}\ **)\ malloc(max\_files\ *\ \textcolor{keyword}{sizeof}(\textcolor{keywordtype}{char}*));\ \textcolor{comment}{//\ freed\ in\ globfree}}
\DoxyCodeLine{00082\ }
\DoxyCodeLine{00083\ \ \ \ \ \textcolor{keywordflow}{if}\ (pglob-\/>\mbox{\hyperlink{structglob__t_a3265051b3f19f438711c2b7699e475b7}{gl\_pathv}}\ ==\ NULL)\ \{}
...
\DoxyCodeLine{00095\ }
\DoxyCodeLine{00096\ \ \ \ \ \ \ \ \ pglob-\/>\mbox{\hyperlink{structglob__t_a3265051b3f19f438711c2b7699e475b7}{gl\_pathv}}[file\_count]\ =\ \_strdup(full\_path);\ \textcolor{comment}{//\ freed\ in\ globfree}}
\DoxyCodeLine{00097\ }
\DoxyCodeLine{00098\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (pglob-\/>\mbox{\hyperlink{structglob__t_a3265051b3f19f438711c2b7699e475b7}{gl\_pathv}}[file\_count]\ ==\ NULL)\ \{}
...
\DoxyCodeLine{00115\ \ \ \ \ \textcolor{keywordtype}{char}\ \mbox{\hyperlink{structdirent_a334c0997a3ca4065bf0761223df5391c}{d\_name}}[\mbox{\hyperlink{OriginalStuff_2dev_2unistd_8h_a9eb6992d76f02128388ae95c0415604a}{MAX\_PATH\_LENGTH}}];}
\DoxyCodeLine{00116\ \}\ \mbox{\hyperlink{dev_2unistd_8h_ae50c911db67dfb4b55fbfc97a557f6f2}{dirent}};}
\DoxyCodeLine{00117\ }
...
\DoxyCodeLine{00122\ \}\ \mbox{\hyperlink{dev_2unistd_8h_a805632179a707f8794b35f089c940cb3}{DIR}};}
\DoxyCodeLine{00123\ }
\DoxyCodeLine{00124\ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ \mbox{\hyperlink{structDIR}{DIR}}\ *\mbox{\hyperlink{dev_2unistd_8h_a4824c86fd36d3e299a4ef8f1469817af}{opendir}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *\mbox{\hyperlink{abseil-cpp_2absl_2synchronization_2mutex_8cc_ac8b44a387cf3da062c4a32316b43962c}{name}})\ \{}
...
\DoxyCodeLine{00128\ \ \ \ \ \}}
\DoxyCodeLine{00129\ }
\DoxyCodeLine{00130\ \ \ \ \ \textcolor{keywordtype}{char}\ searchPath[\mbox{\hyperlink{dev_2unistd_8h_a9eb6992d76f02128388ae95c0415604a}{MAX\_PATH\_LENGTH}}];}
\DoxyCodeLine{00131\ }
\DoxyCodeLine{00132\ \ \ \ \ snprintf(searchPath,\ \mbox{\hyperlink{dev_2unistd_8h_a9eb6992d76f02128388ae95c0415604a}{MAX\_PATH\_LENGTH}},\ \textcolor{stringliteral}{"{}\%s\(\backslash\)\(\backslash\)*.*"{}},\ \mbox{\hyperlink{abseil-cpp_2absl_2synchronization_2mutex_8cc_ac8b44a387cf3da062c4a32316b43962c}{name}});}
\DoxyCodeLine{00133\ }
...
\DoxyCodeLine{00142\ \}}
\DoxyCodeLine{00143\ }
\DoxyCodeLine{00144\ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ \textcolor{keyword}{struct\ }\mbox{\hyperlink{structdirent}{dirent}}\ *\mbox{\hyperlink{dev_2unistd_8h_a2abdafa9cbe8ee370903bcb72f8b9cbd}{readdir}}(\mbox{\hyperlink{structDIR}{DIR}}\ *directory)\ \{}
...
\DoxyCodeLine{00153\ \ \ \ \ \}}
\DoxyCodeLine{00154\ }
\DoxyCodeLine{00155\ \ \ \ \ strncpy(result.\mbox{\hyperlink{structdirent_a334c0997a3ca4065bf0761223df5391c}{d\_name}},\ directory-\/>\mbox{\hyperlink{structDIR_ab84d74272147e61e4fc911a8bc264bcc}{findFileData}}.name,\ \mbox{\hyperlink{dev_2unistd_8h_a9eb6992d76f02128388ae95c0415604a}{MAX\_PATH\_LENGTH}});}
\DoxyCodeLine{00156\ \ \ \ \ result.\mbox{\hyperlink{structdirent_a334c0997a3ca4065bf0761223df5391c}{d\_name}}[\mbox{\hyperlink{dev_2unistd_8h_a9eb6992d76f02128388ae95c0415604a}{MAX\_PATH\_LENGTH}}\ -\/\ 1]\ =\ \textcolor{charliteral}{'\(\backslash\)0'};\ \textcolor{comment}{//\ Ensure\ null\ termination}}
\DoxyCodeLine{00157\ \ \ \ \ \textcolor{keywordflow}{return}\ \&result;}
\DoxyCodeLine{00158\ \}}
\DoxyCodeLine{00159\ }
\DoxyCodeLine{00160\ \textcolor{keyword}{static}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{dev_2unistd_8h_ae6a0856c3a630412cb4e0cad6a386aae}{closedir}}(\mbox{\hyperlink{structDIR}{DIR}}\ *directory)\ \{}
