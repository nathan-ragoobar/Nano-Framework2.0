...
\hypertarget{abseil-cpp_2absl_2status_2internal_2status__matchers_8h_source}{}\label{abseil-cpp_2absl_2status_2internal_2status__matchers_8h_source}\index{abseil-\/cpp/absl/status/internal/status\_matchers.h@{abseil-\/cpp/absl/status/internal/status\_matchers.h}}
\mbox{\hyperlink{abseil-cpp_2absl_2status_2internal_2status__matchers_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00048\ \textcolor{keyword}{class\ }IsOkAndHoldsMatcherImpl}
...
\DoxyCodeLine{00087\ \textcolor{keyword}{class\ }IsOkAndHoldsMatcher\ \{}
...
\DoxyCodeLine{00118\ \textcolor{keyword}{class\ }StatusCode\ \{}
...
\DoxyCodeLine{00136\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespaceabsl__testing_1_1status__internal_a08ee9a856b0e414c2112274dc6463f4d}{operator==}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classabsl__testing_1_1status__internal_1_1StatusCode}{StatusCode}}\&\ lhs,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classabsl__testing_1_1status__internal_1_1StatusCode}{StatusCode}}\&\ rhs)\ \{}
...
\DoxyCodeLine{00138\ \}}
\DoxyCodeLine{00139\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{namespaceabsl__testing_1_1status__internal_adb2312fe7bc88deb6ca69e518dddc50a}{operator!=}}(\textcolor{keyword}{const}\ \mbox{\hyperlink{classabsl__testing_1_1status__internal_1_1StatusCode}{StatusCode}}\&\ lhs,\ \textcolor{keyword}{const}\ \mbox{\hyperlink{classabsl__testing_1_1status__internal_1_1StatusCode}{StatusCode}}\&\ rhs)\ \{}
...
\DoxyCodeLine{00146\ \textcolor{keyword}{class\ }StatusIsMatcherCommonImpl\ \{}
...
\DoxyCodeLine{00194\ \textcolor{keyword}{class\ }StatusIsMatcher\ \{}
...
\DoxyCodeLine{00221\ \textcolor{keyword}{class\ }MonoIsOkMatcherImpl\ :\ \textcolor{keyword}{public}\ ::testing::MatcherInterface<T>\ \{}
...
\DoxyCodeLine{00234\ \textcolor{keyword}{class\ }IsOkMatcher\ \{}
...
\DoxyCodeLine{00238\ \ \ \ \ return\ ::testing::Matcher<T>(\textcolor{keyword}{new}\ MonoIsOkMatcherImpl<const\ T\&>());}
\DoxyCodeLine{00239\ \ \ \}}
\DoxyCodeLine{00240\ \};}
\DoxyCodeLine{00241\ }
