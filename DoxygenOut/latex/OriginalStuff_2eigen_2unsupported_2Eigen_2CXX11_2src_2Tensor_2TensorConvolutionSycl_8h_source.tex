...
\hypertarget{OriginalStuff_2eigen_2unsupported_2Eigen_2CXX11_2src_2Tensor_2TensorConvolutionSycl_8h_source}{}\label{OriginalStuff_2eigen_2unsupported_2Eigen_2CXX11_2src_2Tensor_2TensorConvolutionSycl_8h_source}\index{OriginalStuff/eigen/unsupported/Eigen/CXX11/src/Tensor/TensorConvolutionSycl.h@{OriginalStuff/eigen/unsupported/Eigen/CXX11/src/Tensor/TensorConvolutionSycl.h}}
\mbox{\hyperlink{OriginalStuff_2eigen_2unsupported_2Eigen_2CXX11_2src_2Tensor_2TensorConvolutionSycl_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00038\ \ \ \mbox{\hyperlink{structEigen_1_1EigenConvolutionKernel_3_01Evaluator_00_01CoeffReturnType_00_01KernelType_00_01In7d9bc47fe198f6b0f1b2af8aa5e85d7e_a58a8109c8e12419bc8df614b23af2f10}{Local\_accessor}}\ local\_acc;}
\DoxyCodeLine{00039\ \ \ Evaluator\ device\_evaluator;}
\DoxyCodeLine{00040\ \ \ Kernel\_accessor\ kernel\_filter;}
\DoxyCodeLine{00041\ \ \ Buffer\_accessor\ buffer\_acc;}
\DoxyCodeLine{00042\ \ \ \mbox{\hyperlink{classEigen_1_1internal_1_1IndexMapper}{internal::IndexMapper<Index,\ InputDims,\ 1,\ Evaluator::Layout>}}\ indexMapper;}
\DoxyCodeLine{00043\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{size\_t}\ kernelSize;}
\DoxyCodeLine{00044\ \ \ \textcolor{keyword}{const}\ cl::sycl::range<2>\ input\_range;}
...
\DoxyCodeLine{00105\ \ \ \mbox{\hyperlink{structEigen_1_1EigenConvolutionKernel_3_01Evaluator_00_01CoeffReturnType_00_01KernelType_00_01In02ad0cf76c6b89a09d948e57b1aea49a_a068d069de08810e2a586a2e23663e0fa}{Local\_accessor}}\ local\_acc;}
\DoxyCodeLine{00106\ \ \ Evaluator\ device\_evaluator;}
\DoxyCodeLine{00107\ \ \ Kernel\_accessor\ kernel\_filter;}
\DoxyCodeLine{00108\ \ \ Buffer\_accessor\ buffer\_acc;}
\DoxyCodeLine{00109\ \ \ \mbox{\hyperlink{classEigen_1_1internal_1_1IndexMapper}{internal::IndexMapper<Index,\ InputDims,\ 2,\ Evaluator::Layout>}}\ indexMapper;}
\DoxyCodeLine{00110\ \ \ \textcolor{keyword}{const}\ cl::sycl::range<2>\ kernel\_size;}
\DoxyCodeLine{00111\ \ \ \textcolor{keyword}{const}\ cl::sycl::range<3>\ input\_range;}
...
\DoxyCodeLine{00190\ \ \ \mbox{\hyperlink{structEigen_1_1EigenConvolutionKernel_3_01Evaluator_00_01CoeffReturnType_00_01KernelType_00_01Ina3b20d6496a457db615c11ac009e5142_a265b46c87cdc97ce4ae47429605e35a8}{Local\_accessor}}\ local\_acc;}
\DoxyCodeLine{00191\ \ \ Evaluator\ device\_evaluator;}
\DoxyCodeLine{00192\ \ \ Kernel\_accessor\ kernel\_filter;}
\DoxyCodeLine{00193\ \ \ Buffer\_accessor\ buffer\_acc;}
\DoxyCodeLine{00194\ \ \ \mbox{\hyperlink{classEigen_1_1internal_1_1IndexMapper}{internal::IndexMapper<Index,\ InputDims,\ 3,\ Evaluator::Layout>}}\ indexMapper;}
\DoxyCodeLine{00195\ \ \ \textcolor{keyword}{const}\ cl::sycl::range<3>\ kernel\_size;}
\DoxyCodeLine{00196\ \ \ \textcolor{keyword}{const}\ cl::sycl::range<3>\ input\_range;}
\DoxyCodeLine{00197\ \ \ \textcolor{keyword}{const}\ \textcolor{keywordtype}{size\_t}\ numP;}
\DoxyCodeLine{00198\ }
...
\DoxyCodeLine{00276\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classEigen_1_1TensorConvolutionOp}{TensorConvolutionOp<Indices,\ InputArgType,\ KernelArgType>}}\ \mbox{\hyperlink{structEigen_1_1TensorEvaluator_a8eaecc8ebad5944e6b07db62311b4b49}{XprType}};}
\DoxyCodeLine{00277\ }
...
\DoxyCodeLine{00281\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{classEigen_1_1TensorConvolutionOp_a67db409dd1ded7c9b3d6e8db3a2decd0}{XprType::Index}}\ \mbox{\hyperlink{structEigen_1_1TensorEvaluator_a932b320bc0d4f0c027d28f6f9918bbc6}{Index}};}
\DoxyCodeLine{00282\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{structEigen_1_1DSizes}{DSizes<Index,\ NumDims>}}\ \mbox{\hyperlink{structEigen_1_1TensorEvaluator_ac4139a59583bb1e6385d3a0195548b6b}{Dimensions}};}
...
\DoxyCodeLine{00285\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{classEigen_1_1TensorConvolutionOp_aff5436152ad9a10c3b4ba87826056865}{XprType::CoeffReturnType}}\ \mbox{\hyperlink{structEigen_1_1TensorEvaluator_a664eb29b0c38061939b400fbc551c580}{CoeffReturnType}};}
\DoxyCodeLine{00286\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1PacketType_a1eeaa0a6cdf53f6f0fc3eebacf9590ec}{PacketType<CoeffReturnType,\ Eigen::SyclDevice>::type}}\ \mbox{\hyperlink{structEigen_1_1TensorEvaluator_adff49220cea7a3b0f0abb78fbdaf8287}{PacketReturnType}};}
\DoxyCodeLine{00287\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ InputArgType::Scalar\ \mbox{\hyperlink{structEigen_1_1TensorEvaluator_a163cadb184cc08462355caf1031115a4}{Scalar}};}
...
\DoxyCodeLine{00289\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{structEigen_1_1StorageMemory}{StorageMemory<CoeffReturnType,\ Eigen::SyclDevice>}}\ \mbox{\hyperlink{structEigen_1_1TensorEvaluator_a9cd0cdfa9a85e8e08e3be30386bdfd19}{Storage}};}
\DoxyCodeLine{00290\ \ \ \textcolor{keyword}{typedef}\ \textcolor{keyword}{typename}\ \mbox{\hyperlink{structEigen_1_1MakePointer_a67639bacf48b31d0e052df08cf07dee9}{Storage::Type}}\ \mbox{\hyperlink{structEigen_1_1TensorEvaluator_a313409ea575a90d467d38ef6053a540e}{EvaluatorPointerType}};}
\DoxyCodeLine{00291\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{structEigen_1_1StorageMemory}{StorageMemory<const\ CoeffReturnType,\ Eigen::SyclDevice>}}\ \mbox{\hyperlink{structEigen_1_1StorageMemory}{KernelStorage}};}
\DoxyCodeLine{00292\ }
...
\DoxyCodeLine{00305\ \ \ \textcolor{keyword}{typedef}\ \mbox{\hyperlink{classEigen_1_1internal_1_1TensorBlockNotImplemented}{internal::TensorBlockNotImplemented}}\ \mbox{\hyperlink{structEigen_1_1TensorEvaluator_a40d6c0a3d779598bc003f87027485244}{TensorBlock}};}
