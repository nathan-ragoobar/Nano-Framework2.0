...
\hypertarget{OriginalStuff_2eigen_2unsupported_2Eigen_2src_2NonLinearOptimization_2chkder_8h_source}{}\label{OriginalStuff_2eigen_2unsupported_2Eigen_2src_2NonLinearOptimization_2chkder_8h_source}\index{OriginalStuff/eigen/unsupported/Eigen/src/NonLinearOptimization/chkder.h@{OriginalStuff/eigen/unsupported/Eigen/src/NonLinearOptimization/chkder.h}}
\mbox{\hyperlink{OriginalStuff_2eigen_2unsupported_2Eigen_2src_2NonLinearOptimization_2chkder_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00010\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Matrix<\ Scalar,\ Dynamic,\ 1\ >\ \ \&x,}
\DoxyCodeLine{00011\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Matrix<\ Scalar,\ Dynamic,\ 1\ >\ \ \&fvec,}
\DoxyCodeLine{00012\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Matrix<\ Scalar,\ Dynamic,\ Dynamic\ >\ \&fjac,}
\DoxyCodeLine{00013\ \ \ \ \ \ \ \ \ Matrix<\ Scalar,\ Dynamic,\ 1\ >\ \ \&xp,}
\DoxyCodeLine{00014\ \ \ \ \ \ \ \ \ \textcolor{keyword}{const}\ Matrix<\ Scalar,\ Dynamic,\ 1\ >\ \ \&fvecp,}
\DoxyCodeLine{00015\ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ mode,}
\DoxyCodeLine{00016\ \ \ \ \ \ \ \ \ Matrix<\ Scalar,\ Dynamic,\ 1\ >\ \ \&err}
\DoxyCodeLine{00017\ \ \ \ \ \ \ \ \ )}
\DoxyCodeLine{00018\ \{}
...
\DoxyCodeLine{00024\ }
\DoxyCodeLine{00025\ \ \ \ \ \textcolor{keyword}{const}\ Scalar\ eps\ =\ \mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a656b9217a2fcb6de59dc8d1eb3079cc7}{sqrt}}(\mbox{\hyperlink{structEigen_1_1GenericNumTraits_a3a573c69713fbb143fb49af7db463cee}{NumTraits<Scalar>::epsilon}}());}
...
\DoxyCodeLine{00034\ \ \ \ \ \ \ \ \ xp.resize(\mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__test_8cc_a76f11d9a0a47b94f72c2d0e77fb32240}{n}});}
...
\DoxyCodeLine{00044\ \ \ \ \ \ \ \ \ err.setZero(m);\ }
...
\DoxyCodeLine{00056\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (temp\ >\ \mbox{\hyperlink{structEigen_1_1GenericNumTraits_a3a573c69713fbb143fb49af7db463cee}{NumTraits<Scalar>::epsilon}}()\ \&\&\ temp\ <\ eps)}
