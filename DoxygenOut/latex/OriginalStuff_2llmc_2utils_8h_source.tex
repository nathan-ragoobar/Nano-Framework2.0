\doxysection{utils.\+h}
\hypertarget{OriginalStuff_2llmc_2utils_8h_source}{}\label{OriginalStuff_2llmc_2utils_8h_source}\index{OriginalStuff/llmc/utils.h@{OriginalStuff/llmc/utils.h}}
\mbox{\hyperlink{OriginalStuff_2llmc_2utils_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00065\ }
\DoxyCodeLine{00066\ \textcolor{keyword}{extern}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{llmc_2utils_8h_aa7385fd45a50426cfabce3f4f3bd9998}{fclose\_check}}(FILE\ *fp,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *file,\ \textcolor{keywordtype}{int}\ line)\ \{}
...
\DoxyCodeLine{00077\ }
\DoxyCodeLine{00078\ \textcolor{keyword}{extern}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{llmc_2utils_8h_a247359839e066766716ac575e68aa543}{sclose\_check}}(\textcolor{keywordtype}{int}\ sockfd,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *file,\ \textcolor{keywordtype}{int}\ line)\ \{}
...
\DoxyCodeLine{00103\ }
\DoxyCodeLine{00104\ \textcolor{keyword}{extern}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{llmc_2utils_8h_a198831a1f5d6a27037c56b547caaa09d}{fseek\_check}}(FILE\ *fp,\ \textcolor{keywordtype}{long}\ off,\ \textcolor{keywordtype}{int}\ whence,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *file,\ \textcolor{keywordtype}{int}\ line)\ \{}
...
\DoxyCodeLine{00117\ }
\DoxyCodeLine{00118\ \textcolor{keyword}{extern}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{llmc_2utils_8h_a67684972f313cc5f0f184653c9ca64ed}{fwrite\_check}}(\textcolor{keywordtype}{void}\ *\mbox{\hyperlink{abseil-cpp_2absl_2base_2internal_2low__level__alloc__test_8cc_a935adc2e417a61d7eb6f04efb18ba031}{ptr}},\ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{abseil-cpp_2absl_2base_2internal_2low__level__alloc_8cc_aad9b71a31372d5c0ab9c23163efe9544}{size}},\ \textcolor{keywordtype}{size\_t}\ nmemb,\ FILE\ *stream,\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *file,\ \textcolor{keywordtype}{int}\ line)\ \{}
...
\DoxyCodeLine{00142\ }
\DoxyCodeLine{00143\ \textcolor{keyword}{extern}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ *\mbox{\hyperlink{llmc_2utils_8h_a888f74505bfb2dc8625b41f58d64f4dc}{malloc\_check}}(\textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{abseil-cpp_2absl_2base_2internal_2low__level__alloc_8cc_aad9b71a31372d5c0ab9c23163efe9544}{size}},\ \textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *file,\ \textcolor{keywordtype}{int}\ line)\ \{}
...
\DoxyCodeLine{00179\ }
\DoxyCodeLine{00180\ \textcolor{keyword}{extern}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{void}\ \mbox{\hyperlink{llmc_2utils_8h_aa4cbcc766b41ef573487e4cce3e01af7}{create\_dir\_if\_not\_exists}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}\ *dir)\ \{}
\DoxyCodeLine{00181\ \ \ \ \ \textcolor{keywordflow}{if}\ (dir\ ==\ NULL)\ \{\ \textcolor{keywordflow}{return};\ \}}
\DoxyCodeLine{00182\ \ \ \ \ \textcolor{keyword}{struct\ }\mbox{\hyperlink{dev_2unistd_8h_a149da0702b060478da4d59ffe807adac}{stat}}\ st\ =\ \{0\};}
\DoxyCodeLine{00183\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{dev_2unistd_8h_a149da0702b060478da4d59ffe807adac}{stat}}(dir,\ \&st)\ ==\ -\/1)\ \{}
\DoxyCodeLine{00184\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{dev_2unistd_8h_af6322150fc499c266934fa8926758701}{mkdir}}(dir,\ 0700)\ ==\ -\/1)\ \{}
...
\DoxyCodeLine{00190\ \}}
\DoxyCodeLine{00191\ }
\DoxyCodeLine{00192\ \textcolor{keyword}{extern}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{llmc_2utils_8h_a66e0413aa56d4a9afa63dc1d3dd10fa5}{find\_max\_step}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ output\_log\_dir)\ \{}
...
\DoxyCodeLine{00198\ \ \ \ \ dir\ =\ \mbox{\hyperlink{dev_2unistd_8h_a4824c86fd36d3e299a4ef8f1469817af}{opendir}}(output\_log\_dir);}
\DoxyCodeLine{00199\ \ \ \ \ \textcolor{keywordflow}{if}\ (dir\ ==\ NULL)\ \{\ \textcolor{keywordflow}{return}\ -\/1;\ \}}
\DoxyCodeLine{00200\ \ \ \ \ \textcolor{keywordflow}{while}\ ((entry\ =\ \mbox{\hyperlink{dev_2unistd_8h_a2abdafa9cbe8ee370903bcb72f8b9cbd}{readdir}}(dir))\ !=\ NULL)\ \{}
\DoxyCodeLine{00201\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (strncmp(entry-\/>\mbox{\hyperlink{structdirent_a334c0997a3ca4065bf0761223df5391c}{d\_name}},\ \textcolor{stringliteral}{"{}DONE\_"{}},\ 5)\ ==\ 0)\ \{}
\DoxyCodeLine{00202\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordtype}{int}\ step\ =\ atoi(entry-\/>\mbox{\hyperlink{structdirent_a334c0997a3ca4065bf0761223df5391c}{d\_name}}\ +\ 5);}
\DoxyCodeLine{00203\ \ \ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (step\ >\ max\_step)\ \{}
\DoxyCodeLine{00204\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ max\_step\ =\ step;}
\DoxyCodeLine{00205\ \ \ \ \ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00206\ \ \ \ \ \ \ \ \ \}}
\DoxyCodeLine{00207\ \ \ \ \ \}}
\DoxyCodeLine{00208\ \ \ \ \ \mbox{\hyperlink{dev_2unistd_8h_ae6a0856c3a630412cb4e0cad6a386aae}{closedir}}(dir);}
\DoxyCodeLine{00209\ \ \ \ \ \textcolor{keywordflow}{return}\ max\_step;}
\DoxyCodeLine{00210\ \}}
\DoxyCodeLine{00211\ }
\DoxyCodeLine{00212\ \textcolor{keyword}{extern}\ \textcolor{keyword}{inline}\ \textcolor{keywordtype}{int}\ \mbox{\hyperlink{llmc_2utils_8h_a06031ce67f50400b8bfe0cd332ab14cf}{ends\_with\_bin}}(\textcolor{keyword}{const}\ \textcolor{keywordtype}{char}*\ str)\ \{}
