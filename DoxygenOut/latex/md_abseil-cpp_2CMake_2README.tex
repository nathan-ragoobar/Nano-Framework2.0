...
\hypertarget{md_abseil-cpp_2CMake_2README}{}\label{md_abseil-cpp_2CMake_2README}\index{Abseil CMake Build Instructions@{Abseil CMake Build Instructions}}
\label{md_abseil-cpp_2CMake_2README_autotoc_md4}%
\Hypertarget{md_abseil-cpp_2CMake_2README_autotoc_md4}%
...
For API/\+ABI compatibility reasons, we strongly recommend building Abseil in a subdirectory of your project or as an embedded dependency.\hypertarget{md_abseil-cpp_2CMake_2README_autotoc_md5}{}\doxysection{\texorpdfstring{Incorporating Abseil Into a CMake Project}{Incorporating Abseil Into a CMake Project}}\label{md_abseil-cpp_2CMake_2README_autotoc_md5}
The recommendations below are similar to those for using CMake within the googletest framework (\href{https://github.com/google/googletest/blob/master/googletest/README.md\#incorporating-into-an-existing-cmake-project}{\texttt{ https\+://github.\+com/google/googletest/blob/master/googletest/\+README.\+md\#incorporating-\/into-\/an-\/existing-\/cmake-\/project}})\hypertarget{md_abseil-cpp_2CMake_2README_autotoc_md6}{}\doxysubsection{\texorpdfstring{Step-\/by-\/\+Step Instructions}{Step-\/by-\/\+Step Instructions}}\label{md_abseil-cpp_2CMake_2README_autotoc_md6}
...
Then the top-\/level application project that uses your library is responsible for setting a consistent {\ttfamily CMAKE\+\_\+\+CXX\+\_\+\+STANDARD} that is sufficiently high.\hypertarget{md_abseil-cpp_2CMake_2README_autotoc_md7}{}\doxysubsection{\texorpdfstring{Running Abseil Tests with CMake}{Running Abseil Tests with CMake}}\label{md_abseil-cpp_2CMake_2README_autotoc_md7}
...
\end{DoxyCode}
\hypertarget{md_abseil-cpp_2CMake_2README_autotoc_md9}{}\doxysection{\texorpdfstring{Traditional CMake Set-\/\+Up}{Traditional CMake Set-\/\+Up}}\label{md_abseil-cpp_2CMake_2README_autotoc_md9}
...
\end{DoxyCode}
\hypertarget{md_abseil-cpp_2CMake_2README_autotoc_md10}{}\doxysection{\texorpdfstring{CMake Option Synopsis}{CMake Option Synopsis}}\label{md_abseil-cpp_2CMake_2README_autotoc_md10}
\hypertarget{md_abseil-cpp_2CMake_2README_autotoc_md11}{}\doxysubsection{\texorpdfstring{Enable Standard CMake Installation}{Enable Standard CMake Installation}}\label{md_abseil-cpp_2CMake_2README_autotoc_md11}
{\ttfamily -\/DABSL\+\_\+\+ENABLE\+\_\+\+INSTALL=ON}\hypertarget{md_abseil-cpp_2CMake_2README_autotoc_md12}{}\doxysubsection{\texorpdfstring{Google Test Options}{Google Test Options}}\label{md_abseil-cpp_2CMake_2README_autotoc_md12}
