\chapter{Abseil FAQ}
\hypertarget{md_OriginalStuff_2abseil-cpp_2FAQ}{}\label{md_OriginalStuff_2abseil-cpp_2FAQ}\index{Abseil FAQ@{Abseil FAQ}}
\label{md_OriginalStuff_2abseil-cpp_2FAQ_autotoc_md77}%
\Hypertarget{md_OriginalStuff_2abseil-cpp_2FAQ_autotoc_md77}%
\hypertarget{md_OriginalStuff_2abseil-cpp_2FAQ_autotoc_md78}{}\doxysection{\texorpdfstring{Is Abseil the right home for my utility library?}{Is Abseil the right home for my utility library?}}\label{md_OriginalStuff_2abseil-cpp_2FAQ_autotoc_md78}
Most often the answer to the question is "{}no."{} As both the \href{https://abseil.io/about/}{\texttt{ About Abseil}} page and our \href{https://github.com/abseil/abseil-cpp/blob/master/CONTRIBUTING.md\#contribution-guidelines}{\texttt{ contributing guidelines}} explain, Abseil contains a variety of core C++ library code that is widely used at \href{https://www.google.com/}{\texttt{ Google}}. As such, Abseil\textquotesingle{}s primary purpose is to be used as a dependency by Google\textquotesingle{}s open source C++ projects. While we do hope that Abseil is also useful to the C++ community at large, this added constraint also means that we are unlikely to accept a contribution of utility code that isn\textquotesingle{}t already widely used by Google.\hypertarget{md_OriginalStuff_2abseil-cpp_2FAQ_autotoc_md79}{}\doxysection{\texorpdfstring{How to I set the C++ dialect used to build Abseil?}{How to I set the C++ dialect used to build Abseil?}}\label{md_OriginalStuff_2abseil-cpp_2FAQ_autotoc_md79}
...
For a longer answer to this question and to understand why some other approaches don\textquotesingle{}t work, see the answer to \mbox{[}"{}\+What is ABI and why don\textquotesingle{}t you recommend using a pre-\/compiled version of \+Abseil?"{}\mbox{]}(\#what-\/is-\/abi-\/and-\/why-\/dont-\/you-\/recommend-\/using-\/a-\/pre-\/compiled-\/version-\/of-\/abseil)\hypertarget{md_OriginalStuff_2abseil-cpp_2FAQ_autotoc_md80}{}\doxysection{\texorpdfstring{What is ABI and why don\textquotesingle{}t you recommend using a pre-\/compiled version of Abseil?}{What is ABI and why don\textquotesingle{}t you recommend using a pre-\/compiled version of Abseil?}}\label{md_OriginalStuff_2abseil-cpp_2FAQ_autotoc_md80}
...
For these reasons we recommend you avoid pre-\/compiled code and build the Abseil library yourself in a consistent manner with the rest of your code.\hypertarget{md_OriginalStuff_2abseil-cpp_2FAQ_autotoc_md81}{}\doxysection{\texorpdfstring{What is "{}live at head"{} and how do I do it?}{What is "{}live at head"{} and how do I do it?}}\label{md_OriginalStuff_2abseil-cpp_2FAQ_autotoc_md81}
