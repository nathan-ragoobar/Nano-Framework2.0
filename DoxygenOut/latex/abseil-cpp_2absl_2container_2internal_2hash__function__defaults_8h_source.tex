...
\hypertarget{abseil-cpp_2absl_2container_2internal_2hash__function__defaults_8h_source}{}\label{abseil-cpp_2absl_2container_2internal_2hash__function__defaults_8h_source}\index{abseil-\/cpp/absl/container/internal/hash\_function\_defaults.h@{abseil-\/cpp/absl/container/internal/hash\_function\_defaults.h}}
\mbox{\hyperlink{abseil-cpp_2absl_2container_2internal_2hash__function__defaults_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00071\ \textcolor{keyword}{struct\ }HashEq\ \{}
...
\DoxyCodeLine{00085\ \};}
\DoxyCodeLine{00086\ }
\DoxyCodeLine{00087\ \textcolor{keyword}{struct\ }StringEq\ \{}
...
\DoxyCodeLine{00104\ \textcolor{keyword}{struct\ }StringHashEq\ \{}
...
\DoxyCodeLine{00112\ \textcolor{keyword}{struct\ }HashEq<\mbox{\hyperlink{namespaceabsl}{absl}}::\mbox{\hyperlink{classabsl_1_1string__view}{string\_view}}>\ :\ StringHashEq\ \{\};}
\DoxyCodeLine{00113\ \textcolor{keyword}{template}\ <>}
\DoxyCodeLine{00114\ \textcolor{keyword}{struct\ }HashEq<\mbox{\hyperlink{namespaceabsl}{absl}}::Cord>\ :\ StringHashEq\ \{\};}
\DoxyCodeLine{00115\ }
...
\DoxyCodeLine{00121\ }
\DoxyCodeLine{00122\ \ \ \textcolor{keywordtype}{size\_t}\ \mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2IndexedViewMethods_8h_a745b5bbf26fefb72e16675ef6ccd9057}{operator()}}(std::basic\_string\_view<TChar>\ v)\textcolor{keyword}{\ const\ }\{}
...
\DoxyCodeLine{00130\ \ \ \textcolor{keywordtype}{bool}\ \mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2IndexedViewMethods_8h_a745b5bbf26fefb72e16675ef6ccd9057}{operator()}}(std::basic\_string\_view<TChar>\ lhs,}
...
\DoxyCodeLine{00160\ \textcolor{keyword}{struct\ }HashEq<T*>\ \{}
\DoxyCodeLine{00161\ \ \ \textcolor{keyword}{struct\ }\mbox{\hyperlink{abseil-cpp_2absl_2container_2internal_2hash__function__defaults__test_8cc_a86b49a5b68c9a0e829d44647a771f651}{Hash}}\ \{}
...
\DoxyCodeLine{00166\ \ \ \ \ \}}
\DoxyCodeLine{00167\ \ \ \};}
\DoxyCodeLine{00168\ \ \ \textcolor{keyword}{struct\ }Eq\ \{}
...
\DoxyCodeLine{00189\ \textcolor{keyword}{struct\ }HashEq<\mbox{\hyperlink{namespacestd}{std}}::unique\_ptr<T,\ D>>\ :\ HashEq<T*>\ \{\};}
\DoxyCodeLine{00190\ \textcolor{keyword}{template}\ <\textcolor{keyword}{class}\ T>}
\DoxyCodeLine{00191\ \textcolor{keyword}{struct\ }HashEq<\mbox{\hyperlink{namespacestd}{std}}::shared\_ptr<T>>\ :\ HashEq<T*>\ \{\};}
\DoxyCodeLine{00192\ }
...
\DoxyCodeLine{00194\ \textcolor{keyword}{struct\ }HasAbslContainerHash\ :\ std::false\_type\ \{\};}
\DoxyCodeLine{00195\ }
\DoxyCodeLine{00196\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00197\ \textcolor{keyword}{struct\ }HasAbslContainerHash<T,\ \mbox{\hyperlink{namespaceabsl}{absl}}::\mbox{\hyperlink{namespaceabsl_a5d24e222375f72da89ee76f10480f40c}{void\_t}}<typename\ T::absl\_container\_hash>>}
...
\DoxyCodeLine{00201\ \textcolor{keyword}{struct\ }HasAbslContainerEq\ :\ std::false\_type\ \{\};}
\DoxyCodeLine{00202\ }
\DoxyCodeLine{00203\ \textcolor{keyword}{template}\ <\textcolor{keyword}{typename}\ T>}
\DoxyCodeLine{00204\ \textcolor{keyword}{struct\ }HasAbslContainerEq<T,\ \mbox{\hyperlink{namespaceabsl}{absl}}::\mbox{\hyperlink{namespaceabsl_a5d24e222375f72da89ee76f10480f40c}{void\_t}}<typename\ T::absl\_container\_eq>>}
...
\DoxyCodeLine{00208\ \textcolor{keyword}{struct\ }AbslContainerEq\ \{}
