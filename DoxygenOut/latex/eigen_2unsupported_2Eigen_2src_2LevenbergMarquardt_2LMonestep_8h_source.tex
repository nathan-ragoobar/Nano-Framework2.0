...
\hypertarget{eigen_2unsupported_2Eigen_2src_2LevenbergMarquardt_2LMonestep_8h_source}{}\label{eigen_2unsupported_2Eigen_2src_2LevenbergMarquardt_2LMonestep_8h_source}\index{eigen/unsupported/Eigen/src/LevenbergMarquardt/LMonestep.h@{eigen/unsupported/Eigen/src/LevenbergMarquardt/LMonestep.h}}
\mbox{\hyperlink{eigen_2unsupported_2Eigen_2src_2LevenbergMarquardt_2LMonestep_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
...
\DoxyCodeLine{00025\ \ \ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}\ temp,\ temp1,temp2;\ }
\DoxyCodeLine{00026\ \ \ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}\ ratio;\ }
\DoxyCodeLine{00027\ \ \ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}\ pnorm,\ xnorm,\ fnorm1,\ actred,\ dirder,\ prered;}
\DoxyCodeLine{00028\ \ \ \mbox{\hyperlink{eigen_2Eigen_2src_2Core_2util_2Macros_8h_acaa7ba89800cfe18d5fd6eed620aea9c}{eigen\_assert}}(x.size()==\mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__test_8cc_a76f11d9a0a47b94f72c2d0e77fb32240}{n}});\ \textcolor{comment}{//\ check\ the\ caller\ is\ not\ cheating\ us}}
\DoxyCodeLine{00029\ }
\DoxyCodeLine{00030\ \ \ temp\ =\ 0.0;\ xnorm\ =\ 0.0;}
\DoxyCodeLine{00031\ \ \ \textcolor{comment}{/*\ calculate\ the\ jacobian\ matrix.\ */}}
\DoxyCodeLine{00032\ \ \ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_aebc86d111cde3ceee1003fc038a9e59a}{Index}}\ df\_ret\ =\ m\_functor.df(x,\ m\_fjac);}
...
\DoxyCodeLine{00043\ \ \ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ac83d1eedcf52eec974135ee32c20f8fa}{QRSolver}}\ qrfac(m\_fjac);}
\DoxyCodeLine{00044\ \ \ \textcolor{keywordflow}{if}(qrfac.info()\ !=\ \mbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea52581b035f4b59c203b8ff999ef5fcea}{Success}})\ \{}
\DoxyCodeLine{00045\ \ \ \ \ m\_info\ =\ \mbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5eaaf9b736d310a664e7729d163a035cc5f}{NumericalIssue}};}
...
\DoxyCodeLine{00056\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_aebc86d111cde3ceee1003fc038a9e59a}{Index}}\ j\ =\ 0;\ j\ <\ \mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__test_8cc_a76f11d9a0a47b94f72c2d0e77fb32240}{n}};\ ++j)}
...
\DoxyCodeLine{00076\ \ \ \ \ \ \ \textcolor{keywordflow}{for}\ (\mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_aebc86d111cde3ceee1003fc038a9e59a}{Index}}\ j\ =\ 0;\ j\ <\ \mbox{\hyperlink{abseil-cpp_2absl_2container_2btree__test_8cc_a76f11d9a0a47b94f72c2d0e77fb32240}{n}};\ ++j)}
\DoxyCodeLine{00077\ \ \ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (m\_wa2[m\_permutation.indices()[j]]\ !=\ 0.)}
\DoxyCodeLine{00078\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ m\_gnorm\ =\ (std::max)(m\_gnorm,\ \mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a35560f7dbf19244fda7e463d14157c43}{abs}}(\ m\_rfactor.col(j).head(j+1).dot(m\_qtf.head(j+1)/m\_fnorm)\ /\ m\_wa2[m\_permutation.indices()[j]]));}
\DoxyCodeLine{00079\ }
...
\DoxyCodeLine{00082\ \ \ \ \ m\_info\ =\ \mbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea52581b035f4b59c203b8ff999ef5fcea}{Success}};}
...
\DoxyCodeLine{00111\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_adad8b90c9020a9b8b20af524a6374ae1}{Scalar}}(.1)\ *\ fnorm1\ <\ m\_fnorm)}
...
\DoxyCodeLine{00118\ \ \ \ \ temp2\ =\ \mbox{\hyperlink{namespaceEigen_1_1numext_ad59216129a430099e97b4c4b1e2f2984}{numext::abs2}}(\mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a656b9217a2fcb6de59dc8d1eb3079cc7}{sqrt}}(m\_par)\ *\ pnorm\ /\ m\_fnorm);}
\DoxyCodeLine{00119\ \ \ \ \ prered\ =\ temp1\ +\ temp2\ /\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_adad8b90c9020a9b8b20af524a6374ae1}{Scalar}}(.5);}
...
\DoxyCodeLine{00129\ \ \ \ \ \textcolor{keywordflow}{if}\ (ratio\ <=\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_adad8b90c9020a9b8b20af524a6374ae1}{Scalar}}(.25))\ \{}
\DoxyCodeLine{00130\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (actred\ >=\ 0.)}
\DoxyCodeLine{00131\ \ \ \ \ \ \ \ \ \ \ \ \ temp\ =\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}(.5);}
\DoxyCodeLine{00132\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (actred\ <\ 0.)}
\DoxyCodeLine{00133\ \ \ \ \ \ \ \ \ \ \ \ \ temp\ =\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}(.5)\ *\ dirder\ /\ (dirder\ +\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}(.5)\ *\ actred);}
\DoxyCodeLine{00134\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}(.1)\ *\ fnorm1\ >=\ m\_fnorm\ ||\ temp\ <\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}(.1))}
\DoxyCodeLine{00135\ \ \ \ \ \ \ \ \ \ \ \ \ temp\ =\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_adad8b90c9020a9b8b20af524a6374ae1}{Scalar}}(.1);}
\DoxyCodeLine{00136\ \ \ \ \ \ \ \ \ \textcolor{comment}{/*\ Computing\ MIN\ */}}
\DoxyCodeLine{00137\ \ \ \ \ \ \ \ \ m\_delta\ =\ temp\ *\ (std::min)(m\_delta,\ pnorm\ /\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}(.1));}
\DoxyCodeLine{00138\ \ \ \ \ \ \ \ \ m\_par\ /=\ temp;}
\DoxyCodeLine{00139\ \ \ \ \ \}\ \textcolor{keywordflow}{else}\ \textcolor{keywordflow}{if}\ (!(m\_par\ !=\ 0.\ \&\&\ ratio\ <\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}(.75)))\ \{}
\DoxyCodeLine{00140\ \ \ \ \ \ \ \ \ m\_delta\ =\ pnorm\ /\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}(.5);}
\DoxyCodeLine{00141\ \ \ \ \ \ \ \ \ m\_par\ =\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}(.5)\ *\ m\_par;}
\DoxyCodeLine{00142\ \ \ \ \ \}}
\DoxyCodeLine{00143\ }
\DoxyCodeLine{00144\ \ \ \ \ \textcolor{comment}{/*\ test\ for\ successful\ iteration.\ */}}
\DoxyCodeLine{00145\ \ \ \ \ \textcolor{keywordflow}{if}\ (ratio\ >=\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_ab0dd958a8ef7f95559ea9c2390253d74}{RealScalar}}(1e-\/4))\ \{}
...
\DoxyCodeLine{00156\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a35560f7dbf19244fda7e463d14157c43}{abs}}(actred)\ <=\ m\_ftol\ \&\&\ prered\ <=\ m\_ftol\ \&\&\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_adad8b90c9020a9b8b20af524a6374ae1}{Scalar}}(.5)\ *\ ratio\ <=\ 1.\ \&\&\ m\_delta\ <=\ m\_xtol\ *\ xnorm)}
\DoxyCodeLine{00157\ \ \ \ \ \{}
\DoxyCodeLine{00158\ \ \ \ \ \ \ \ m\_info\ =\ \mbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea52581b035f4b59c203b8ff999ef5fcea}{Success}};}
...
\DoxyCodeLine{00160\ \ \ \ \ \}}
\DoxyCodeLine{00161\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a35560f7dbf19244fda7e463d14157c43}{abs}}(actred)\ <=\ m\_ftol\ \&\&\ prered\ <=\ m\_ftol\ \&\&\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_adad8b90c9020a9b8b20af524a6374ae1}{Scalar}}(.5)\ *\ ratio\ <=\ 1.)\ }
\DoxyCodeLine{00162\ \ \ \ \ \{}
\DoxyCodeLine{00163\ \ \ \ \ \ \ m\_info\ =\ \mbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea52581b035f4b59c203b8ff999ef5fcea}{Success}};}
...
\DoxyCodeLine{00167\ \ \ \ \ \{}
\DoxyCodeLine{00168\ \ \ \ \ \ \ m\_info\ =\ \mbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea52581b035f4b59c203b8ff999ef5fcea}{Success}};}
...
\DoxyCodeLine{00174\ \ \ \ \ \{}
\DoxyCodeLine{00175\ \ \ \ \ \ \ m\_info\ =\ \mbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5eaba1c8763d1179778070f365ecc4157a8}{NoConvergence}};}
...
\DoxyCodeLine{00177\ \ \ \ \ \}}
\DoxyCodeLine{00178\ \ \ \ \ \textcolor{keywordflow}{if}\ (\mbox{\hyperlink{eigen_2Eigen_2src_2plugins_2ArrayCwiseUnaryOps_8h_a35560f7dbf19244fda7e463d14157c43}{abs}}(actred)\ <=\ \mbox{\hyperlink{structEigen_1_1NumTraits}{NumTraits<Scalar>::epsilon}}()\ \&\&\ prered\ <=\ \mbox{\hyperlink{structEigen_1_1NumTraits}{NumTraits<Scalar>::epsilon}}()\ \&\&\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_adad8b90c9020a9b8b20af524a6374ae1}{Scalar}}(.5)\ *\ ratio\ <=\ 1.)}
\DoxyCodeLine{00179\ \ \ \ \ \{}
\DoxyCodeLine{00180\ \ \ \ \ \ \ m\_info\ =\ \mbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea52581b035f4b59c203b8ff999ef5fcea}{Success}};}
...
\DoxyCodeLine{00184\ \ \ \ \ \{}
\DoxyCodeLine{00185\ \ \ \ \ \ \ m\_info\ =\ \mbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea52581b035f4b59c203b8ff999ef5fcea}{Success}};}
...
\DoxyCodeLine{00189\ \ \ \ \ \{}
\DoxyCodeLine{00190\ \ \ \ \ \ \ m\_info\ =\ \mbox{\hyperlink{group__enums_gga85fad7b87587764e5cf6b513a9e0ee5ea52581b035f4b59c203b8ff999ef5fcea}{Success}};}
...
\DoxyCodeLine{00192\ \ \ \ \ \}}
\DoxyCodeLine{00193\ }
\DoxyCodeLine{00194\ \ \ \}\ \textcolor{keywordflow}{while}\ (ratio\ <\ \mbox{\hyperlink{classEigen_1_1LevenbergMarquardt_adad8b90c9020a9b8b20af524a6374ae1}{Scalar}}(1e-\/4));}
\DoxyCodeLine{00195\ }
